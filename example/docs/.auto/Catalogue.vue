<template>
  <div class="component-catalogue">
    <div class="update-datetime">文档更新时间：2020-01-14 17:45</div>
    <h2 id="catalogue-mu-lu" class="mz-header mz-document-header" data-level="2"><a class="mz-document-anchor" href="#catalogue-mu-lu" title="Catalogue 目录" data-level="2" data-href="#catalogue-mu-lu">¶</a><div class="mz-header__title">Catalogue 目录</div></h2>
<p>用于列出页面目录。</p>
...
<demo-block>
...
</div></catalogue-demo1></template>
        <template #description><p>当 catalogue 组件的<code>manual</code>属性为 true，默认插槽才可以使用。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-catalogue manual&gt;
  &lt;mz-catalogue-item title=&quot;标题1&quot; :level=&quot;1&quot;&gt;
    &lt;mz-catalogue-item title=&quot;标题1-1&quot; :level=&quot;2&quot;&gt;
      &lt;mz-catalogue-item title=&quot;标题1-1-1&quot; :level=&quot;3&quot;&gt;&lt;/mz-catalogue-item&gt;
      &lt;mz-catalogue-item title=&quot;标题1-1-2&quot; :level=&quot;3&quot;&gt;&lt;/mz-catalogue-item&gt;
  ...
  &lt;/mz-catalogue-item&gt;
&lt;/mz-catalogue&gt;
</code></pre></template></demo-block><h3 id="mao-dian-mu-lu" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#mao-dian-mu-lu" title="锚点目录" data-level="3" data-href="#mao-dian-mu-lu">¶</a><div class="mz-header__title">锚点目录</div></h3>
<p>有位置跳转功能的目录。</p>
<demo-block>
...
</div></catalogue-demo2></template>
        <template #description><p>catalogue-item 的<code>target</code>属性指向页面锚点元素的 id。</p>
</template>
 ...
 &lt;mz-col :span=&quot;8&quot;&gt;
  ...
  &lt;/mz-col&gt;
&lt;/mz-row&gt;
</code></pre></template></demo-block><h3 id="gu-ding-ding-wei-mu-lu" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#gu-ding-ding-wei-mu-lu" title="固定定位目录" data-level="3" data-href="#gu-ding-ding-wei-mu-lu">¶</a><div class="mz-header__title">固定定位目录</div></h3>
<p>将目录固定在某一个位置。</p>
<demo-block>
...
</div></catalogue-demo3></template>
        <template #description><p><code>fixed</code>属性控制是否固定。<code>offset</code>控制固定的偏移。</p>
</template>
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="you-ce-bian-xian-mu-lu" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#you-ce-bian-xian-mu-lu" title="有侧边线目录" data-level="3" data-href="#you-ce-bian-xian-mu-lu">¶</a><div class="mz-header__title">有侧边线目录</div></h3>
<p>左侧有节点线条。</p>
<demo-block>
...
</div></catalogue-demo4></template>
        <template #description><p>通过<code>sidebar</code>属性控制线条显示与否。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-catalogue manual sidebar&gt;
  &lt;mz-catalogue-item title=&quot;标题1&quot; :level=&quot;1&quot;&gt;
    &lt;mz-catalogue-item title=&quot;标题1-1&quot; :level=&quot;2&quot;&gt;
      &lt;mz-catalogue-item title=&quot;标题1-1-1&quot; :level=&quot;3&quot;&gt;&lt;/mz-catalogue-item&gt;
      &lt;mz-catalogue-item title=&quot;标题1-1-2&quot; :level=&quot;3&quot;&gt;&lt;/mz-catalogue-item&gt;
  ...
  &lt;/mz-catalogue-item&gt;
&lt;/mz-catalogue&gt;
</code></pre></template></demo-block><h3 id="yu-mao-dian-lian-dong" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#yu-mao-dian-lian-dong" title="与锚点联动" data-level="3" data-href="#yu-mao-dian-lian-dong">¶</a><div class="mz-header__title">与锚点联动</div></h3>
...
<demo-block>
  ...
  &lt;/mz-col&gt;
&lt;/mz-row&gt;
</code></pre></template></demo-block><h3 id="ping-hua-gun-dong" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#ping-hua-gun-dong" title="平滑滚动" data-level="3" data-href="#ping-hua-gun-dong">¶</a><div class="mz-header__title">平滑滚动</div></h3>
...
<demo-block>
  ...
  <mz-row>
    ...
    <mz-col :span="12">
      <mz-catalogue sidebar scroll-by-js 
        ...
        <template #description><p>注意: 该方法使用了<code>Element.scrollIntoView({ behavior: 'smooth' })</code>，浏览器兼容性<code>firefox 36+ | chrome 61+ | Opera 48+</code>。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-row&gt;
  &lt;mz-col :span=&quot;12&quot; 
    id=&quot;demo-anchor-scroll-container-2&quot; 
  ...
  &lt;/mz-col&gt;
&lt;/mz-row&gt;
</code></pre></template></demo-block><h3 id="catalogue-api" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#catalogue-api" title="Catalogue API" data-level="3" data-href="#catalogue-api">¶</a><div class="mz-header__title">Catalogue API</div></h3>
...
<h4 id="fang-fa" class="mz-header mz-document-header" data-level="4"><a class="mz-document-anchor" href="#fang-fa" title="方法" data-level="4" data-href="#fang-fa">¶</a><div class="mz-header__title">方法</div></h4>
<table>
<thead>
<tr>
<th>名称</th>
...
<h3 id="catalogueitem-api" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#catalogueitem-api" title="CatalogueItem API" data-level="3" data-href="#catalogueitem-api">¶</a><div class="mz-header__title">CatalogueItem API</div></h3>
...
<h4 id="cha-cao-2" class="mz-header mz-document-header" data-level="4"><a class="mz-document-anchor" href="#cha-cao-2" title="插槽" data-level="4" data-href="#cha-cao-2">¶</a><div class="mz-header__title">插槽</div></h4>
<table>
<thead>
<tr>
<th>名称</th>
