...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="you-ce-bian-xian-mu-lu"><a class="mz-document-anchor" href="#you-ce-bian-xian-mu-lu">¶</a>有侧边线目录</h3>
<p>左侧有节点线条。</p>
<demo-block>
  ...
  &lt;/mz-catalogue-item&gt;
&lt;/mz-catalogue&gt;
</code></pre></template></demo-block><h3 id="yu-mao-dian-lian-dong"><a class="mz-document-anchor" href="#yu-mao-dian-lian-dong">¶</a>与锚点联动</h3>
...
<demo-block>
  ...
  <mz-row>
    ...
    <mz-col :span="12">
      <mz-catalogue sidebar
        ...
        <template #description><p>将 catalogue 设置 <code>anchorClassName</code>(自动匹配的锚点class名称)，与 anchor 设置 <code>anchorClass</code>(锚点class名称)保持一致。这样可以避免锚点出现互串的情况。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-row&gt;
  &lt;mz-col :span=&quot;12&quot; 
    id=&quot;demo-anchor-scroll-container&quot; 
  ...
  &lt;/mz-col&gt;
&lt;/mz-row&gt;
</code></pre></template></demo-block><h3 id="ping-hua-gun-dong"><a class="mz-document-anchor" href="#ping-hua-gun-dong">¶</a>平滑滚动</h3>
...
<demo-block>
  ...
  &lt;/mz-col&gt;
&lt;/mz-row&gt;
</code></pre></template></demo-block><h3 id="catalogue-api"><a class="mz-document-anchor" href="#catalogue-api">¶</a>Catalogue API</h3>
...
<h4 id="fang-fa"><a class="mz-document-anchor" href="#fang-fa">¶</a>方法</h4>
<table>
<thead>
<tr>
<th>名称</th>
...
<h3 id="catalogueitem-api"><a class="mz-document-anchor" href="#catalogueitem-api">¶</a>CatalogueItem API</h3>
...
<h4 id="cha-cao-2"><a class="mz-document-anchor" href="#cha-cao-2">¶</a>插槽</h4>
<table>
<thead>
<tr>
<th>名称</th>
