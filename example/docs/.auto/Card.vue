<template>
  <div class="component-card">
    ...
    <h2 id="card-qia-pian" class="mz-header mz-document-header" data-level="2"><a class="mz-document-anchor" href="#card-qia-pian" title="Card 卡片" data-level="2" data-href="#card-qia-pian">¶</a><div class="mz-header__title">Card 卡片</div></h2>
<p>以卡片显示展示内容。</p>
<h3 id="qia-pian-hai-ba" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#qia-pian-hai-ba" title="卡片海拔" data-level="3" data-href="#qia-pian-hai-ba">¶</a><div class="mz-header__title">卡片海拔</div></h3>
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="xian-tiao-qia-pian" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#xian-tiao-qia-pian" title="线条卡片" data-level="3" data-href="#xian-tiao-qia-pian">¶</a><div class="mz-header__title">线条卡片</div></h3>
<p>有线条围绕的扁平卡片</p>
<demo-block>
