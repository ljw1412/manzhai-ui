<template>
  <div class="component-grid">
    ...
    <h2
      id="grid-zha-ge-bu-ju"
      class="mz-heading mz-document-heading"
      data-level="2"
    >
      <a
        class="mz-document-anchor"
        href="#grid-zha-ge-bu-ju"
        title="Grid 栅格布局"
        data-level="2"
        data-href="#grid-zha-ge-bu-ju"
        >¶</a
      >Grid 栅格布局
    </h2>
    <p>按照 24 等分的原则进行划分。</p>
    <h3 id="ji-chu-bu-ju" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#ji-chu-bu-ju"
        title="基础布局"
        data-level="3"
        data-href="#ji-chu-bu-ju"
        >¶</a
      >基础布局
    </h3>
    <p>固定等分的基础栅格布局。</p>
        ...
        ><grid-demo1 inline-template
          ><div class="grid-demo1">
            ...
            <mz-row>
              ...
              <mz-col :span="4"><div class="grid-col bg-base"></div></mz-col>
              <mz-col :span="4"><div class="grid-col bg-light"></div></mz-col>
            </mz-row></div></grid-demo1
      ></template>
      <template #description
        ><p>
          通过设置 col 的 <code>span</code>属性我们可以进行列的不同组合搭配。
        </p>
      </template>
      <template #highlight
...
&lt;/style&gt;
    ...
    >
      <a
        ...
        title="列的间隔"
        data-level="3"
        data-href="#lie-de-jian-ge"
        >¶</a
      >列的间隔
    </h3>
    <demo-block>
      <template #example
        ><grid-demo2 inline-template
          ><div class="grid-demo2">
            ...
            <mz-row :gutter="16">
              ...
              <mz-col :span="6"><div class="grid-col bg-base"></div></mz-col>
              <mz-col :span="6"><div class="grid-col bg-light"></div></mz-col>
            </mz-row></div></grid-demo2
      ></template>
      <template #description
        ><p>
          通过 row 的<code>gutter</code>属性来指定每一栏之间的间隔，默认间隔为
          0。
        </p>
      </template>
      <template #highlight
...
&lt;/style&gt;
      ...
      ></demo-block
    >
    <h3 id="zi-you-bu-ju" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#zi-you-bu-ju"
        title="自由布局"
        data-level="3"
        data-href="#zi-you-bu-ju"
        >¶</a
      >自由布局
    </h3>
...
&lt;/style&gt;
    ...
    <demo-block>
      <template #example
        ><grid-demo4 inline-template
          ><div class="grid-demo4">
            <mz-row :gutter="16">
              <mz-col :span="6"><div class="grid-col bg-base"></div></mz-col>
              <mz-col :span="6" :offset="6"
                ><div class="grid-col bg-base"></div
              ></mz-col>
            </mz-row>
            ...
            <mz-row :gutter="16">
              <mz-col :span="12" :offset="6"
                ><div class="grid-col bg-base"></div
              ></mz-col>
            </mz-row></div></grid-demo4
      ></template>
      <template #description
        ><p>通过设置col的<code>offset</code>属性可以使当前列偏移指定列数。</p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-row :gutter=&quot;16&quot;&gt;
  &lt;mz-col :span=&quot;6&quot;&gt;&lt;div class=&quot;grid-col bg-base&quot;&gt;&lt;/div&gt;&lt;/mz-col&gt;
...
&lt;/style&gt;
    ...
    <demo-block>
      <template #example
        ><grid-demo5 inline-template
          ><div class="grid-demo5">
            <mz-row flex :justify="justify" :align="align">
              <mz-col :span="6"><div class="grid-col bg-base"></div></mz-col>
              <mz-col :span="6"
                ><div class="grid-col bg-light" style="height:64px"></div
              ></mz-col>
              <mz-col :span="6"><div class="grid-col bg-base"></div></mz-col>
            </mz-row>
            <br />
            ...
            <mz-filter-section v-model="justify" label="justify">
              <mz-filter-section-item
                ...
                :value="item"
              ></mz-filter-section-item>
            </mz-filter-section></div></grid-demo5
      ></template>
      <template #description
        ><p>
          通过设置 row 的<code>flex</code>属性，来启用 flex
          布局。启动之后，可以通过<code>justify</code>属性指定 'start',
          'center', 'end', 'space-between', 'space-around',
          'space-evenly'中的值来定义列元素的水平布局。通过<code>align</code>属性指定'top',
          'middle', 'bottom'中的值来定义列的垂直布局。
        </p>
      </template>
      <pre><code class="language-html">&lt;mz-row flex :justify=&quot;justify&quot; :align=&quot;align&quot;&gt;
  &lt;mz-col :span=&quot;6&quot;&gt;&lt;div class=&quot;grid-col bg-base&quot;&gt;&lt;/div&gt;&lt;/mz-col&gt;
...
&lt;/style&gt;
    ...
    >
      <a
        ...
        title="响应式布局"
        data-level="3"
        data-href="#xiang-ying-shi-bu-ju"
        >¶</a
      >响应式布局
    </h3>
    <p>
      参考 Bootstrap 的
      响应式设计，预设了五个响应尺寸：<code>xs</code>、<code>sm</code>、<code>md</code>、<code>lg</code>和<code>xl</code>。
    </p>
    <demo-block>
      <template #example
        ><grid-demo6 inline-template
          ><div class="grid-demo6">
            <mz-row :gutter="16">
              <mz-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1"
                ><div class="grid-col bg-base"></div
              ></mz-col>
              <mz-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11"
                ><div class="grid-col bg-light"></div
              ></mz-col>
              <mz-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11"
                ><div class="grid-col bg-light"></div
              ></mz-col>
...
&lt;/style&gt;
    ...
    >
      <a
        class="mz-document-anchor"
        href="#lie-de-yin-cang"
        title="列的隐藏"
        data-level="3"
        data-href="#lie-de-yin-cang"
        >¶</a
      >列的隐藏
    </h3>
    <p>在某些情况下，隐藏部分列。</p>
    <demo-block>
      <template #example
        ><grid-demo7 inline-template
          ><div class="grid-demo7">
            <mz-row :gutter="16">
      ...
      <template #description
        ><p>
          将col的属性值
          <code>span</code
          >、<code>xs</code>、<code>sm</code>、<code>md</code>、<code>lg</code>、<code>xl</code>设为0即可。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-row :gutter=&quot;16&quot;&gt;
...
&lt;/style&gt;
      ...
      ></demo-block
    >
    <h3 id="row-api" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#row-api"
        title="Row Api"
    ...
    <h3 id="col-api" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#col-api"
        title="Col Api"
