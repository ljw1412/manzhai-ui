  ...
  <div class="component-progress">
    ...
    >
      <a
        ...
        title="Progress 进度条"
        data-level="2"
        data-href="#progress-jin-du-tiao"
        >¶</a
      >Progress 进度条
    </h2>
    <p>用于展示操作进度。</p>
    ...
    <demo-block>
      <template #example
        ><progress-demo1 inline-template
          ><div class="progress-demo1">
      ...
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-progress v-model=&quot;value&quot;&gt;&lt;/mz-progress&gt;
&lt;mz-progress v-model=&quot;value&quot; color=&quot;#43a047&quot;&gt;&lt;/mz-progress&gt;
&lt;mz-progress v-model=&quot;value&quot; color=&quot;#ffc107&quot;&gt;&lt;/mz-progress&gt;
&lt;mz-progress v-model=&quot;value&quot; color=&quot;#ed4014&quot;&gt;&lt;/mz-progress&gt;
&lt;mz-progress v-model=&quot;value&quot; color=&quot;#6200ea&quot;&gt;&lt;/mz-progress&gt;
...
&lt;/script&gt;
      ...
      ></demo-block
    >
    <h3 id="huan-chong" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#huan-chong"
        title="缓冲"
        data-level="3"
        data-href="#huan-chong"
        >¶</a
      >缓冲
    </h3>
    <p>显示缓存进度的进度条。</p>
    <demo-block>
      <template #example
        ><progress-demo2 inline-template
          ><div class="progress-demo2">
            ...
            <mz-progress
              ...
              :buffer="buffer"
              color="#6200ea"
            ></mz-progress></div></progress-demo2
      ></template>
      <template #description
        ><p><code>buffer</code>属性来控制当前缓存进度。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-progress v-model=&quot;value&quot; :buffer=&quot;buffer&quot;&gt;&lt;/mz-progress&gt;
...
&lt;/script&gt;
    ...
    >
    <h3
      id="bu-que-ding-jin-du"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#bu-que-ding-jin-du"
        title="不确定进度"
        data-level="3"
        data-href="#bu-que-ding-jin-du"
        >¶</a
      >不确定进度
    </h3>
    <p>使用动画效果表示不确定当前进度。</p>
    <demo-block>
      <template #example
        ><progress-demo3 inline-template
          ><div class="progress-demo3">
            ...
            <mz-progress
              indeterminate
              color="#6200ea"
            ></mz-progress></div></progress-demo3
      ></template>
      <template #description
        ><p>
          <code>indeterminate</code>属性来控制进度条的不确定状态，默认为 false。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-progress indeterminate&gt;&lt;/mz-progress&gt;
&lt;mz-progress indeterminate color=&quot;#43a047&quot;&gt;&lt;/mz-progress&gt;
&lt;mz-progress indeterminate color=&quot;#ffc107&quot;&gt;&lt;/mz-progress&gt;
&lt;mz-progress indeterminate color=&quot;#ed4014&quot;&gt;&lt;/mz-progress&gt;
&lt;mz-progress indeterminate color=&quot;#6200ea&quot;&gt;&lt;/mz-progress&gt;
    ...
    >
    <h3
      id="bu-que-ding-jin-du-jiao-ti"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#bu-que-ding-jin-du-jiao-ti"
        title="不确定进度(交替)"
        data-level="3"
        data-href="#bu-que-ding-jin-du-jiao-ti"
        >¶</a
      >不确定进度(交替)
    </h3>
    <p>可以用来表示来回的等待状态。</p>
    <demo-block>
      <template #example
        ><progress-demo4 inline-template
          ><div class="progress-demo4">
            ...
            <mz-progress
              ...
              alternate
              color="#6200ea"
            ></mz-progress></div></progress-demo4
      ></template>
      <template #description
        ><p>
          <code>alternate</code>属性来控制进度条的不确定状态的动画为交替，默认为
          false，且只在<code>indeterminate</code>为true时有效。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-progress indeterminate alternate&gt;&lt;/mz-progress&gt;
&lt;mz-progress indeterminate alternate color=&quot;#43a047&quot;&gt;&lt;/mz-progress&gt;
&lt;mz-progress indeterminate alternate color=&quot;#ffc107&quot;&gt;&lt;/mz-progress&gt;
&lt;mz-progress indeterminate alternate color=&quot;#ed4014&quot;&gt;&lt;/mz-progress&gt;
&lt;mz-progress indeterminate alternate color=&quot;#6200ea&quot;&gt;&lt;/mz-progress&gt;
      ...
      ></demo-block
    >
    <h3 id="yuan-jiao" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#yuan-jiao"
        title="圆角"
    ...
    <demo-block>
      <template #example
        ><progress-demo5 inline-template
          ><div class="progress-demo5">
            ...
            <mz-progress
              ...
              rounded
              color="#43a047"
            ></mz-progress></div></progress-demo5
      ></template>
      <template #description
        ><p><code>rounded</code>属性来控制进度条的圆角状态，默认为 false。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-progress v-model=&quot;value&quot; :buffer=&quot;buffer&quot; rounded&gt;&lt;/mz-progress&gt;
...
&lt;/script&gt;
    ...
    <demo-block>
      <template #example
        ><progress-demo6 inline-template
          ><div class="progress-demo6">
            <mz-progress
              v-model="value"
              :buffer="buffer"
              color="#6200ea"
            ...
            ></mz-progress></div></progress-demo6
      ></template>
      <template #description
        ><p>
          <code>color</code
          >控制主进度的颜色，默认值主题色。<code>buffer-color</code>控制缓存进度的颜色，<code>background-color</code>控制背景的颜色。当<code>buffer-color</code>、<code>background-color</code>值不存在时，会采用主进度的颜色带上0.3透明度。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-progress v-model=&quot;value&quot;
  :buffer=&quot;buffer&quot;
  color=&quot;#6200ea&quot;
  buffer-color=&quot;#ffc107&quot;
...
&lt;/script&gt;
      ...
      ></demo-block
    >
    <h3 id="ban-ma-wen" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#ban-ma-wen"
        title="斑马纹"
        data-level="3"
        data-href="#ban-ma-wen"
        >¶</a
      >斑马纹
    </h3>
    <demo-block>
      <template #example
        ><progress-demo7 inline-template
          ><div class="progress-demo7">
            <mz-progress
              v-model="value"
              :buffer="buffer"
              :stroke-width="12"
            ...
            <mz-progress
              ...
              :stroke-width="12"
              striped-animation
            ></mz-progress></div></progress-demo7
      ></template>
      <template #description
        ><p>
          <code>striped</code
          >属性来控制进度条是否用斑马纹效果，<code>striped-animation</code>属性来控制进度条是否有动画效果的斑马纹。
        </p>
      </template>
      <template #highlight
        >><pre
