...
<demo-block>
  ...
  <template #description>
    <p><code>visible/v-model</code>属性控制对话框的显示隐藏。<code>divider</code>属性控制是否使用分割线分隔。不使用<code>title</code>属性且不用<code>title</code>插槽，将不渲染对话框头部。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-button color=&quot;success&quot;
  @click=&quot;visible = true&quot;&gt;显示对话框&lt;/mz-button&gt;
&lt;mz-modal v-model=&quot;visible&quot; title=&quot;对话框&quot;&gt;
  &lt;div&gt;Welcome to chaos world!&lt;/div&gt;
  &lt;template #footer&gt;
...
<demo-block>
  ...
  <template #description>
    <p><span style="color:var(--color-danger)">原则上禁止嵌套弹窗，因为这样做可能会导致弹窗和遮罩的层级的关系错误。</span>如果需要在页面上同时显示多个 Dialog，可以将它们平级放置。如果万不得已一定要用，Model 组件提供了<code>append-to-body</code>属性，将内层 Model  的该属性设置为 true，它就会插入至 body 元素上，从而保证内外层 Model 和遮罩层级关系的正确。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-button color=&quot;success&quot;
  @click=&quot;visible = true&quot;&gt;显示对话框&lt;/mz-button&gt;
...
<demo-block>
  ...
  <template #description>
    <p><code>before-close</code>属性可以拦截关闭事件，传入 function(done) 方法，<code>done</code>为关闭的方法。你也可以传入 Promise。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-button color=&quot;success&quot;
  @click=&quot;show&quot;&gt;显示对话框&lt;/mz-button&gt;
...
<demo-block>
  ...
  <template #description>
    <p><code>close-on-click-mask</code>属性控制对话框是否允许点击遮罩关闭。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-button color=&quot;success&quot;
  @click=&quot;visible = true&quot;&gt;显示对话框&lt;/mz-button&gt;
&lt;mz-modal v-model=&quot;visible&quot; title=&quot;对话框&quot; :close-on-click-mask=&quot;false&quot;&gt;
  &lt;div&gt;Welcome to chaos world!&lt;/div&gt;
...
<demo-block>
  ...
  <template #description>
      </template><template #highlight><pre v-pre><code class="html">&lt;!-- alert --&gt;
&lt;mz-button @click=&quot;alert&quot;&gt;Alert&lt;/mz-button&gt;
&lt;mz-button @click=&quot;confirm&quot;&gt;Confirm&lt;/mz-button&gt;
&lt;mz-button @click=&quot;prompt&quot;&gt;Prompt&lt;/mz-button&gt;
&lt;mz-button @click=&quot;promptWithRule&quot;&gt;带校验的Prompt&lt;/mz-button&gt;
