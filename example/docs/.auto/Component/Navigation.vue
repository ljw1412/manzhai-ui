  ...
  <div class="component-navigation">
    ...
    >
      <a
        ...
        href="#dao-hang-cai-dan"
        title="导航菜单"
        data-level="2"
        data-href="#dao-hang-cai-dan"
        >¶</a
      >导航菜单
    </h2>
    <p>有站点导航功能的菜单。</p>
        ...
        ><navigation-demo1 inline-template
          ><div class="navigation-demo1">
            <mz-navigation
              :data="data"
              style="width:300px"
            ></mz-navigation></div></navigation-demo1
      ></template>
      <template #description></template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-navigation :data=&quot;data&quot;
