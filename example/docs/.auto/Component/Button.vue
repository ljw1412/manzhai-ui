      ...
      <template #example
        ><button-demo1 inline-template
          ><div class="button-demo1">
            ...
            </div></div></button-demo1
      ></template>
      <template #description
        ><p>
          使用<code>color</code>、<code>outlined</code>、<code>flat</code>、<code>round</code>、<code>circle</code>、<code>icon</code>属性来定义
          Button
          的样式。你可以通过<code>disabled</code>属性来修改按钮的禁用状态。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;span class=&quot;demo-font-size-14&quot;&gt;状态控制: &lt;/span&gt;
&lt;mz-checkbox-group v-model=&quot;checkedList&quot;&gt;
...
&lt;/script&gt;
    ...
    <demo-block>
      <template #example
        ><button-demo2 inline-template
          ><div class="button-demo2">
            <div>
            ...
            <div>
              <mz-button color="primary" outlined size="large"
                >线条按钮</mz-button
              >
              <mz-button color="primary" outlined>线条按钮</mz-button>
              <mz-button color="primary" outlined size="medium"
                >线条按钮</mz-button
              >
              <mz-button color="primary" outlined size="small"
                >线条按钮</mz-button
              >
            </div>
            ...
            <div>
              ...
              <mz-button color="primary" round size="medium"
                >圆角按钮</mz-button
              >
      ...
      <template #description
        ><p>
          尺寸有<code>small</code>、<code>medium</code>、<code>(默认)</code>、<code>large</code>，通过设置size属性来配置它们。
        </p>
      </template>
      <template #highlight
...
&lt;/div&gt;
    ...
    >
      <a
        ...
        title="紧凑按钮"
        data-level="3"
        data-href="#jin-cou-an-niu"
        >¶</a
      >紧凑按钮
    </h3>
    <demo-block>
      <template #example
        ><button-demo3 inline-template
          ><div class="button-demo3">
      ...
      >
      <template #description
        ><p><code>dense</code>属性控制按钮内部文字到边距更近些。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-button color=&quot;primary&quot; size=&quot;large&quot;&gt;松&lt;/mz-button&gt;
&lt;mz-button color=&quot;primary&quot; size=&quot;large&quot; dense&gt;紧&lt;/mz-button&gt;
&lt;mz-button color=&quot;primary&quot;&gt;松&lt;/mz-button&gt;
&lt;mz-button color=&quot;primary&quot; dense&gt;紧&lt;/mz-button&gt;
&lt;mz-button color=&quot;primary&quot; size=&quot;medium&quot;&gt;松&lt;/mz-button&gt;
...
&lt;mz-button color=&quot;primary&quot; size=&quot;small&quot; dense&gt;紧&lt;/mz-button&gt;
    ...
    >
      <a
        class="mz-document-anchor"
        href="#an-niu-yin-ying"
        title="按钮阴影"
        data-level="3"
        data-href="#an-niu-yin-ying"
        >¶</a
      >按钮阴影
    </h3>
    <demo-block>
      <template #example
        ><button-demo4 inline-template
          ><div class="button-demo4">
      ...
      >
      <template #description
        ><p><code>shadow</code>属性控制是否使用按钮阴影效果。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-button color=&quot;primary&quot; size=&quot;large&quot; shadow&gt;按钮阴影&lt;/mz-button&gt;
&lt;mz-button color=&quot;primary&quot; shadow&gt;按钮阴影&lt;/mz-button&gt;
&lt;mz-button color=&quot;primary&quot; size=&quot;medium&quot; shadow&gt;按钮阴影&lt;/mz-button&gt;
&lt;mz-button color=&quot;primary&quot; size=&quot;small&quot; shadow&gt;按钮阴影&lt;/mz-button&gt;
</code></pre></template</template
    ...
    <demo-block>
      <template #example
        ><button-demo5 inline-template
          ><div class="button-demo5">
            <div>
              ...
              <mz-button outlined text-color="#fcba2a" border-color="blue"
                >按钮</mz-button
              >
            </div>
          </div></button-demo5
      ...
      <template #description
        ><p>
          <code>color</code
          >属性控制背景颜色，预设了<code>primary</code>、<code>success</code>、<code>warning</code>、<code>danger</code>。<code>text-color</code>属性控制文字颜色。<code>border-color</code>属性控制边框颜色(仅在outlined下有效)，默认会取文字颜色。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;div&gt;
...
&lt;/div&gt;
      ...
      ></demo-block
    >
    <h3 id="an-niu-zu" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#an-niu-zu"
        title="按钮组"
    ...
    <demo-block>
      <template #example
        ><button-demo6 inline-template
          ><div class="button-demo6">
            <mz-button-group>
      ...
      <template #description
        ><p>
          使用<code>mz-button-group</code>组件将按钮归为一个组。注意：插槽内只允许传入<code>mz-button</code>组件。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-button-group&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;按钮1&lt;/mz-button&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;按钮2&lt;/mz-button&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;按钮3&lt;/mz-button&gt;
&lt;/mz-button-group&gt;
...
&lt;/mz-button-group&gt;
      ...
      ></demo-block
    >
    <h3 id="button-api" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#button-api"
        title="Button API"
        data-level="3"
        data-href="#button-api"
        >¶</a
      >Button API
    </h3>
    ...
    >
      <a
        class="mz-document-anchor"
        href="#buttongroup-api"
        title="ButtonGroup API"
        data-level="3"
        data-href="#buttongroup-api"
        >¶</a
      >ButtonGroup API
    </h3>
