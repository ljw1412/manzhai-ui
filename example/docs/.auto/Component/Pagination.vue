<template>
  <div class="component-pagination">
    <div class="update-datetime">文档更新时间：2020-07-23 11:32</div>
      ...
      <demo-block>
        <template #example>
          <pagination-demo1 inline-template>
            <div class="pagination-demo1">
        ...
        <template #description>
          <p><code>index/v-model</code>绑定当前页码。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-pagination v-model=&quot;index&quot; 
        :page-size=&quot;10&quot; :total=&quot;70&quot;&gt;&lt;/mz-pagination&gt;
      ...
      &lt;/script&gt;
      </code></pre></template></demo-block><h3 id="she-zhi-zui-da-xian-shi-ye-ma-shu" class="mz-heading mz-document-heading" data-level="3"><a class="mz-document-anchor" href="#she-zhi-zui-da-xian-shi-ye-ma-shu" title="设置最大显示页码数" data-level="3" data-href="#she-zhi-zui-da-xian-shi-ye-ma-shu">¶</a>设置最大显示页码数</h3>
      <demo-block>
        <template #example>
          <pagination-demo2 inline-template>
        ...
        <template #description>
          <p><code>max</code>属性设置最大显示页码数，即总页数超过<code>max</code>会折叠多余的页码按钮。默认值<code>7</code>,可选值<code>4到20之间的奇数</code>。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-pagination 
        v-model=&quot;index&quot; 
        :page-size=&quot;10&quot;
        :total=&quot;198&quot;
        :max=&quot;13&quot;&gt;&lt;/mz-pagination&gt;
      ...
      &lt;/script&gt;
      </code></pre></template></demo-block><h3 id="yuan-jiao-he-wai-bian-kuang" class="mz-heading mz-document-heading" data-level="3"><a class="mz-document-anchor" href="#yuan-jiao-he-wai-bian-kuang" title="圆角和外边框" data-level="3" data-href="#yuan-jiao-he-wai-bian-kuang">¶</a>圆角和外边框</h3>
      <demo-block>
        <template #example>
          <pagination-demo3 inline-template>
            <div class="pagination-demo3">
        ...
        <template #description>
          <p><code>outlined</code>和<code>circle</code>分别控制是否显示外边框和是否为圆角。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-pagination v-model=&quot;index2&quot; outlined
        :page-size=&quot;10&quot; :total=&quot;198&quot;&gt;&lt;/mz-pagination&gt;
      ...
      &lt;/script&gt;
      </code></pre></template></demo-block><h3 id="zi-ding-yi-bu-ju" class="mz-heading mz-document-heading" data-level="3"><a class="mz-document-anchor" href="#zi-ding-yi-bu-ju" title="自定义布局" data-level="3" data-href="#zi-ding-yi-bu-ju">¶</a>自定义布局</h3>
      <demo-block>
        <template #example>
      ...
      <demo-block>
        <template #example>
          <pagination-demo5 inline-template>
            <div class="pagination-demo5">
              <mz-pagination 
                v-model="index" 
                :layout="['|', 'total', 'prev', 'pager', 'next']"
                :page-size="10" 
        ...
        <template #description>
          <p>在<code>layout</code>属性中，使用<code>|</code>符号分隔左右。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-pagination 
        v-model=&quot;index&quot; 
        :layout=&quot;['|', 'total', 'prev', 'pager', 'next']&quot;
        :page-size=&quot;10&quot; 
      ...
      <demo-block>
        <template #example>
          <pagination-demo6 inline-template>
            <div class="pagination-demo6">
        ...
        <template #description>
          <p><code>size</code>属性控制分页组件的大小，可选值<code>small</code>、<code>medium</code>、<code>(默认)</code>、<code>large</code>。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-pagination v-model=&quot;index&quot; size=&quot;small&quot;
        :layout=&quot;['total', 'sizes', 'prev', 'pager', 'next', 'jumper']&quot;
        :page-size.sync=&quot;pageSize1&quot; :total=&quot;100&quot;&gt;&lt;/mz-pagination&gt;
      ...
      <tr>
      <td>pageSizes</td>
      <td>每页显示个数选择器的选项设置，需要配合total属性</td>
      <td>number[]</td>
      <td></td>
