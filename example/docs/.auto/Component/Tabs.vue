<template>
  <div class="component-tabs">
    <div class="update-datetime">文档更新时间：2020-07-20 18:45</div>
      ...
      <demo-block>
        <template #example>
          <tabs-demo1 inline-template>
            <div class="tabs-demo1">
        ...
        <template #description>
          <p>tabs的<code>value</code>/<code>v-model</code>表示当前显示的标签值，即与tab的<code>value</code>属性对应。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-tabs v-model=&quot;value&quot;&gt;
        &lt;mz-tab v-for=&quot;index of 5&quot;
          :key=&quot;index&quot;
          :label=&quot;'Tab'+index&quot;
          :value=&quot;index&quot;&gt;标签页{{index}}&lt;/mz-tab&gt;
      ...
      <demo-block>
        <template #example>
          <tabs-demo2 inline-template>
            <div class="tabs-demo2">
        ...
        <template #description>
          <p>tabs的<code>grow</code>属性可以控制标签是否平铺。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-tabs v-model=&quot;value&quot; grow&gt;
        &lt;mz-tab v-for=&quot;index of 5&quot;
          :key=&quot;index&quot;
          :label=&quot;'Tab'+index&quot;
          :value=&quot;index&quot;&gt;标签页{{index}}&lt;/mz-tab&gt;
      ...
      <demo-block>
        <template #example>
          <tabs-demo3 inline-template>
            <div class="tabs-demo3">
        ...
        <template #description>
          <p>tabs的<code>active-bar-mode</code>表示当前选中的标签的底标模式，可选值<code>fill</code>，默认值<code>none~</code>。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-tabs v-model=&quot;value&quot; active-bar-mode=&quot;fill&quot;&gt;
        &lt;mz-tab v-for=&quot;index of 5&quot;
          :key=&quot;index&quot;
          :label=&quot;'Tab'+index&quot;
          :value=&quot;index&quot;&gt;标签页{{index}}&lt;/mz-tab&gt;
      ...
      <demo-block>
        <template #example>
          <tabs-demo4 inline-template>
            <div class="tabs-demo4">
              <mz-tabs v-model="value" grow>
        ...
        <template #description>
          <p>当tabs下的tab超出显示范围，将以滚动显示进行显示。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-tabs v-model=&quot;value&quot; grow&gt;
        &lt;mz-tab v-for=&quot;index of 30&quot;
          :key=&quot;index&quot;
          :label=&quot;'Tab'+index&quot;
      ...
      <demo-block>
        <template #example>
          <tabs-demo5 inline-template>
            <div class="tabs-demo5">
        ...
        <template #description>
          <p><code>align</code> 属性控制标签的水平位置，可选值<code>left</code> 、 <code>center</code> 、 <code>right</code>。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-filter-section v-model=&quot;align&quot; label=&quot;align:&quot; label-position=&quot;left&quot;&gt;
        &lt;mz-filter-section-item v-for=&quot;item of alignList&quot;
          :key=&quot;item&quot;
          :value=&quot;item&quot;&gt;&lt;/mz-filter-section-item&gt;
      &lt;/mz-filter-section&gt;
