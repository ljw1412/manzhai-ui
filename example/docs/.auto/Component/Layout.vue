<template>
  <div class="component-layout">
    ...
    <h2 id="layout-bu-ju" class="mz-heading mz-document-heading" data-level="2">
      <a
        class="mz-document-anchor"
        href="#layout-bu-ju"
        title="Layout 布局"
        data-level="2"
        data-href="#layout-bu-ju"
        >¶</a
      >Layout 布局
    </h2>
    <h3
    ...
    >
      <a
        class="mz-document-anchor"
        href="#chang-jian-bu-ju"
        title="常见布局"
        data-level="3"
        data-href="#chang-jian-bu-ju"
        >¶</a
      >常见布局
    </h3>
    <demo-block>
      ...
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-layout class=&quot;layout-type&quot;&gt;
  &lt;mz-header&gt;Header&lt;/mz-header&gt;
  &lt;mz-main&gt;Main&lt;/mz-main&gt;
  &lt;mz-footer&gt;Footer&lt;/mz-footer&gt;
&lt;/mz-layout&gt;
