...
<demo-block>
  <template #example>
    <list-demo1 inline-template>
      <div class="list-demo1">
  ...
  <template #description>
      </template><template #highlight><pre v-pre><code class="html">&lt;mz-card width=&quot;300px&quot; class=&quot;m-auto&quot;&gt;
  &lt;mz-list&gt;
    &lt;mz-list-item title=&quot;所有人&quot; text=&quot;来个火箭&quot;&gt;
      &lt;mz-icon slot=&quot;prefix&quot; name=&quot;at&quot; size=&quot;30&quot;&gt;&lt;/mz-icon&gt;
    &lt;/mz-list-item&gt;
...
<demo-block>
  <template #example>
    <list-demo2 inline-template>
      <div class="list-demo2">
        <mz-card width="300px" class="m-auto">
          <mz-list divider>
            <mz-list-item title="所有人" text="来个火箭">
              <mz-icon slot="prefix" name="at" size="30"></mz-icon>
  ...
  <template #description>
    <p><code>divider</code>可以控制列表是否带有分割线。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-card width=&quot;300px&quot; class=&quot;m-auto&quot;&gt;
  &lt;mz-list divider&gt;
    &lt;mz-list-item title=&quot;所有人&quot; text=&quot;来个火箭&quot;&gt;
      &lt;mz-icon slot=&quot;prefix&quot; name=&quot;at&quot; size=&quot;30&quot;&gt;&lt;/mz-icon&gt;
...
<demo-block>
  <template #example>
    <list-demo3 inline-template>
      <div class="list-demo3">
        <mz-card width="300px" class="m-auto">
          <mz-list clickable>
            <mz-list-item title="所有人" text="来个火箭">
              <mz-icon slot="prefix" name="at" size="30"></mz-icon>
  ...
  <template #description>
    <p><code>clickable</code>控制能否点击的效果。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-card width=&quot;300px&quot; class=&quot;m-auto&quot;&gt;
  &lt;mz-list clickable&gt;
    &lt;mz-list-item title=&quot;所有人&quot; text=&quot;来个火箭&quot;&gt;
      &lt;mz-icon slot=&quot;prefix&quot; name=&quot;at&quot; size=&quot;30&quot;&gt;&lt;/mz-icon&gt;
...
<demo-block>
  <template #example>
    <list-demo4 inline-template>
      <div class="list-demo4">
  ...
  <template #description>
    <p><code>gutter</code>可以控制列表元素间的间距。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-list width=&quot;300px&quot; class=&quot;m-auto&quot; gutter=&quot;10px&quot;&gt;
  &lt;mz-list-item v-for=&quot;i of 4&quot; :key=&quot;i&quot;&gt;
    &lt;mz-card height=&quot;50px&quot;&gt;&lt;span&gt;我是卡片{{i}}&lt;/span&gt;&lt;/mz-card&gt;
  &lt;/mz-list-item&gt;
&lt;/mz-list&gt;
...
<demo-block>
  <template #example>
    <list-demo5 inline-template>
      <div class="list-demo5">
        <mz-card width="300px">
          <mz-list disabled>
            <mz-list-item title="所有人" text="来个火箭">
              <mz-icon slot="prefix" name="at" size="30"></mz-icon>
  ...
  <template #description>
    <p>List的<code>disabled</code>属性可以控制整个列表的禁用状态。也可以单独控制ListItem。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-card width=&quot;300px&quot;&gt;
  &lt;mz-list disabled&gt;
    &lt;mz-list-item title=&quot;所有人&quot; text=&quot;来个火箭&quot;&gt;
      &lt;mz-icon slot=&quot;prefix&quot; name=&quot;at&quot; size=&quot;30&quot;&gt;&lt;/mz-icon&gt;
    &lt;/mz-list-item&gt;
...
<demo-block>
  <template #example>
    <list-demo6 inline-template>
      <div class="list-demo6">
  ...
  <template #description>
    <p>当<code>list</code>有<code>value/v-model</code>属性时，进入选择模式，且<code>list-item</code>的<code>value</code>属性不能为<code>undefined</code>，使用<code>list-item</code>的<code>item</code>属性传入任意相关数据。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-list v-model=&quot;value&quot; 
  width=&quot;300px&quot; class=&quot;m-auto&quot;
  @change=&quot;change&quot; @item-click=&quot;itemClick&quot;&gt;
  &lt;mz-list-item v-for=&quot;item of list&quot;
    :item=&quot;item&quot;
...
<demo-block>
  <template #example>
    <list-demo7 inline-template>
      <div class="list-demo7">
  ...
  <template #description>
    <p><code>size</code>属性控制列表的大小，可选值<code>small</code>、<code>medium</code>、<code>(默认)</code>、<code>large</code>。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-card v-for=&quot;size of sizeList&quot;
   width=&quot;200px&quot; :key=&quot;size&quot;&gt;
  &lt;mz-list :size=&quot;size&quot;&gt;
    &lt;mz-list-item title=&quot;所有人&quot; text=&quot;来个火箭&quot;&gt;
      &lt;mz-icon slot=&quot;prefix&quot; name=&quot;at&quot; size=&quot;30&quot;&gt;&lt;/mz-icon&gt;
...
<demo-block>
  <template #example>
    <list-demo8 inline-template>
      <div class="list-demo8">
        <mz-card width="300px">
...
<td>change</td>
<td>选中改变事件</td>
<td>(value:选中的值,item:元素挂载的item属性)</td>
</tr>
<tr>
<td>item-click</td>
<td>元素点击事件</td>
<td>(value:选中的值,item:元素挂载的item属性,disabled:禁用状态)</td>
</tr>
</tbody>
</table>
...
<tr>
<td>content</td>
<td>中间内容，<code>title</code>，<code>text</code>所在的整体</td>
<td></td>
</tr>
<tr>
<td>title</td>
