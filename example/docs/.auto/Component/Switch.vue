        ...
        ><switch-demo1 inline-template
          ><div class="switch-demo1">
            ...
            <mz-switch
              ...
              circle
              disabled
            ></mz-switch></div></switch-demo1
      ></template>
      <template #description
        ><p>
          <code>circle</code
          >属性可以控制滑块是否为圆形。<code>disabled</code>属性可以控制开关是否禁用。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-switch v-model=&quot;value&quot;&gt;&lt;/mz-switch&gt;
&lt;mz-switch v-model=&quot;value&quot; disabled&gt;&lt;/mz-switch&gt;
&lt;mz-switch v-model=&quot;value&quot; circle&gt;&lt;/mz-switch&gt;
        ...
        ><switch-demo2 inline-template
          ><div class="switch-demo2">
            ...
            <mz-switch
              v-model="value"
              size="large"
            ></mz-switch></div></switch-demo2
      ></template>
      <template #description
        ><p>
          <code>size</code>属性控制开关大小，可选值: small / (默认) / large。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-switch v-model=&quot;value&quot; size=&quot;small&quot;&gt;&lt;/mz-switch&gt;
&lt;mz-switch v-model=&quot;value&quot;&gt;&lt;/mz-switch&gt;
...
&lt;/script&gt;
    ...
    >
    <h3
      id="zhuang-tai-tu-biao"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#zhuang-tai-tu-biao"
        title="状态图标"
        data-level="3"
        data-href="#zhuang-tai-tu-biao"
        >¶</a
      >状态图标
    </h3>
    <demo-block>
      <template #example
        ><switch-demo3 inline-template
          ><div class="switch-demo3">
            <mz-switch
              ...
              active-icon="moon"
              inactive-icon="sunny"
            ></mz-switch></div></switch-demo3
      ></template>
      <template #description
        ><p>
          <code>active-icon</code
          >为开关开启的图标，<code>inactive-icon</code>为开关关闭的图标。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-switch v-model=&quot;value&quot; 
  size=&quot;large&quot;
  active-icon=&quot;moon&quot; 
