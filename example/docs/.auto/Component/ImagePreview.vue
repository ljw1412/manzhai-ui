<template>
  <div class="component-image-preview">
    ...
    <h2
      id="imagepreview-tu-pian-yu-lan"
      class="mz-heading mz-document-heading"
      data-level="2"
    >
      <a
        class="mz-document-anchor"
        href="#imagepreview-tu-pian-yu-lan"
        title="ImagePreview 图片预览"
        data-level="2"
        data-href="#imagepreview-tu-pian-yu-lan"
        >¶</a
      >ImagePreview 图片预览
    </h2>
    <p>以页面全屏的形式预览图片。</p>
    ...
    <demo-block>
      <template #example
        ><image-preview-demo1 inline-template
          ><div class="image-preview-demo1">
            <mz-button @click="visible = true">预览</mz-button>
            <mz-image-preview
              v-model="visible"
              :images="images"
            ></mz-image-preview></div></image-preview-demo1
      ></template>
      <template #description
        ><p><code>images</code>传递图片列表。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-button @click=&quot;visible = true&quot;&gt;预览&lt;/mz-button&gt;
...
&lt;/script&gt;
    ...
    >
      <a
        class="mz-document-anchor"
        href="#gong-neng-bu-ju"
        title="功能布局"
        data-level="3"
        data-href="#gong-neng-bu-ju"
        >¶</a
      >功能布局
    </h3>
    ...
    <demo-block>
      <template #example
        ><image-preview-demo2 inline-template
          ><div class="image-preview-demo2">
            <mz-image-preview
              v-model="visible"
              :layout="layout"
              :images="images"
          ...
          </div></image-preview-demo2
        ></template
      >
      <template #description
        ><p>
          <code>layout</code>属性控制布局的展示效果，可选值<code>zoom</code>,
          <code>play</code>, <code>fullscreen</code>, <code>download</code>,
          <code>thumbnail</code>，多个布局以英文逗号或者空格分隔。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-image-preview v-model=&quot;visible&quot;
  :layout=&quot;layout&quot;
  :images=&quot;images&quot;&gt;&lt;/mz-image-preview&gt;
&lt;mz-checkbox-group v-model=&quot;checkList&quot;&gt;
  &lt;mz-checkbox value=&quot;zoom&quot;&gt;zoom&lt;/mz-checkbox&gt;
...
&lt;/script&gt;
    ...
    >
    <h3
      id="shi-yong-zhi-ling-xing-shi"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#shi-yong-zhi-ling-xing-shi"
        title="使用指令形式"
        data-level="3"
        data-href="#shi-yong-zhi-ling-xing-shi"
        >¶</a
      >使用指令形式
    </h3>
    ...
    <demo-block>
      <template #example
        ><image-preview-demo3 inline-template
          ><div class="image-preview-demo3">
            <mz-button @click="show">预览</mz-button>
          </div></image-preview-demo3
        ></template
      >
      ...
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-button @click=&quot;show&quot;&gt;预览&lt;/mz-button&gt;
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>布局，以空格分隔</td>
          <td>String</td>
          <td><code>zoom play fullscreen download thumbnail</code></td>
          <td>''</td>
        </tr>
        <tr>
          <td>images</td>
          <td>图片列表</td>
          <td>
            String[] / { url: string; title?: string; thumbnail?: string }[]
          </td>
          <td></td>
          <td>[]</td>
        </tr>
