...
<demo-block>
  <template #example>
    <textarea-demo1 inline-template>
      <div class="textarea-demo1">
        <mz-textarea v-model="value" placeholder="请输入"></mz-textarea>
      </div>
    </textarea-demo1>
  </template>
  <template #description>
      </template><template #highlight><pre v-pre><code class="html">&lt;mz-textarea v-model=&quot;value&quot; placeholder=&quot;请输入&quot;&gt;&lt;/mz-textarea&gt;
...
<demo-block>
  <template #example>
    <textarea-demo3 inline-template>
      <div class="textarea-demo3">
  ...
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-textarea v-model=&quot;value&quot; placeholder=&quot;请输入&quot; disabled&gt;&lt;/mz-textarea&gt;
