<template>
  <div class="component-input">
    <div class="update-datetime">文档更新时间：2020-07-20 18:45</div>
      ...
      <demo-block>
        <template #example>
          <input-demo1 inline-template>
            <div class="input-demo1">
              <mz-input v-model="value" placeholder="请输入文字"></mz-input>
            </div>
          </input-demo1>
        </template>
        <template #description>
            </template><template #highlight><pre v-pre><code class="html">&lt;mz-input v-model=&quot;value&quot; placeholder=&quot;请输入文字&quot;&gt;&lt;/mz-input&gt;
      ...
      <demo-block>
        <template #example>
          <input-demo2 inline-template>
            <div class="input-demo2">
        ...
        <template #description>
          <p><code>rounded</code>属性控制是否使用圆角显示。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-input v-model=&quot;value&quot; placeholder=&quot;请输入文字&quot; rounded&gt;
      &lt;/mz-input&gt;
      ...
      <demo-block>
        <template #example>
          <input-demo3 inline-template>
            <div class="input-demo3">
        ...
        <template #description>
          <p><code>size</code>属性控制输入框的大小，可选值<code>small</code>、<code>medium</code>、<code>(默认)</code>、<code>large</code>。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-input v-model=&quot;value&quot; placeholder=&quot;小&quot; size=&quot;small&quot;&gt;
      &lt;/mz-input&gt;
      &lt;mz-input v-model=&quot;value&quot; placeholder=&quot;中&quot; size=&quot;medium&quot;&gt;
      &lt;/mz-input&gt;
      &lt;mz-input v-model=&quot;value&quot; placeholder=&quot;默认&quot;&gt;
      ...
      <demo-block>
        <template #example>
          <input-demo4 inline-template>
            <div class="input-demo4">
        ...
        <template #description>
          <p><code>flat</code>属性控制是否使用扁平效果。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-input v-model=&quot;value&quot;
        placeholder=&quot;请输入文字&quot;
        flat&gt;&lt;/mz-input&gt;
      ...
      <demo-block>
        <template #example>
          <input-demo5 inline-template>
            <div class="input-demo5">
              <mz-input v-model="value"
                placeholder="请输入文字"
                shadow></mz-input>
            </div>
        ...
        <template #description>
          <p><code>shadow</code>属性控制是否使用阴影显示。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-input v-model=&quot;value&quot;
        placeholder=&quot;请输入文字&quot;
        shadow&gt;&lt;/mz-input&gt;
      ...
      <demo-block>
        <template #example>
          <input-demo6 inline-template>
            <div class="input-demo6">
        ...
        <template #description>
          <p><code>prefix</code>、<code>suffix</code>属性添加字符型的前置内容。你也可以使用同名插槽进行更多的扩展。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-input v-model=&quot;username&quot; placeholder=&quot;请输入用户名&quot;&gt;
        &lt;mz-icon name=&quot;person&quot; slot=&quot;prefix&quot;&gt;&lt;/mz-icon&gt;
      &lt;/mz-input&gt;
      ...
      <demo-block>
        <template #example>
          <input-demo7 inline-template>
            <div class="input-demo7">
        ...
        <template #description>
          <p><code>disabled</code>属性控制是否禁用。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-input v-model=&quot;value&quot; disabled&gt;&lt;/mz-input&gt;
      &lt;mz-input v-model=&quot;value&quot; disabled rounded&gt;&lt;/mz-input&gt;
      ...
      <demo-block>
        <template #example>
          <input-demo8 inline-template>
            <div class="input-demo8">
              <mz-input-group>  
        ...
        <template #description>
            </template><template #highlight><pre v-pre><code class="html">&lt;mz-input-group&gt;  
        &lt;mz-select v-model=&quot;protocol&quot;&gt;
          &lt;mz-option value=&quot;http://&quot;&gt;&lt;/mz-option&gt;
          &lt;mz-option value=&quot;https://&quot;&gt;&lt;/mz-option&gt;
          &lt;mz-option value=&quot;ftp://&quot;&gt;&lt;/mz-option&gt;
      ...
      <tr>
      <td>type</td>
      <td>同原生 <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#Form_%3Cinput%3E_types">type</a></td>
      <td>String</td>
      <td></td>
      <td></td>
      </tr>
