<template>
  <div class="component-tooltip">
    ...
    <h2
      id="tooltip-ti-shi-wen-zi"
      class="mz-heading mz-document-heading"
      data-level="2"
    >
      <a
        class="mz-document-anchor"
        href="#tooltip-ti-shi-wen-zi"
        title="Tooltip 提示文字"
        data-level="2"
        data-href="#tooltip-ti-shi-wen-zi"
        >¶</a
      >Tooltip 提示文字
    </h2>
    <p>常用于用户使用鼠标与元素交互时，显示的对被交互元素起提示作用的信息。</p>
    <p>
      基于开源项目<a href="https://github.com/atomiks/tippyjs" target="_blank"
        ><code>Tippy.js</code></a
      >。
    </p>
    <h3
      id="ji-chu-yong-fa"
    ...
    >
      <a
        ...
        title="基础用法"
        data-level="3"
        data-href="#ji-chu-yong-fa"
        >¶</a
      >基础用法
    </h3>
    <demo-block>
      <template #example
        ><tooltip-demo1 inline-template
      ...
      <template #description
        ><p>
          <code>content</code
          >属性控制显示提示的提示信息。<code>placement</code>属性控制显示提示的位置。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;div class=&quot;box&quot;&gt;
  &lt;div class=&quot;top&quot;&gt;
    &lt;mz-tooltip placement=&quot;top-start&quot; content=&quot;top-start 提示文字&quot;&gt;
      &lt;mz-button color=&quot;primary&quot;&gt;top-start&lt;/mz-button&gt;
    &lt;/mz-tooltip&gt;
...
&lt;/style&gt;
    ...
    >
      <a
        ...
        title="触发方式"
        data-level="3"
        data-href="#chu-fa-fang-shi"
        >¶</a
      >触发方式
    </h3>
    <demo-block>
      <template #example
        ><tooltip-demo2 inline-template
          ><div class="tooltip-demo2">
            ...
            ></mz-switch></div></tooltip-demo2
      ></template>
      <template #description
        ><p>
          <code>trigger</code
          >属性控制触发方式，默认值<code>hover</code>，可选值<code>hover</code>、<code>click</code>、<code>focus</code>、<code>manual</code>。<code>hide-on-click</code>属性控制触发逻辑，<code>true</code>:点击外部会隐藏，<code>false</code>:点击外部不会隐藏，<code>'toggle'</code>:点击自己显示和隐藏。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-tooltip content=&quot;鼠标悬停触发&quot; trigger=&quot;hover&quot;&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;hover&lt;/mz-button&gt;
&lt;/mz-tooltip&gt;
&lt;mz-tooltip content=&quot;鼠标点击触发&quot; trigger=&quot;click&quot;&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;click&lt;/mz-button&gt;
...
&lt;/style&gt;
    ...
    >
    <h3
      id="xian-shi-jian-tou"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#xian-shi-jian-tou"
        title="显示箭头"
        data-level="3"
        data-href="#xian-shi-jian-tou"
        >¶</a
      >显示箭头
    </h3>
    <demo-block>
      <template #example
        ><tooltip-demo3 inline-template
          ><div class="tooltip-demo3">
      ...
      <template #description
        ><p>
          设置<code>arrow</code>属性控制是否显示箭头，类型<code>Boolean</code>、<code>String</code>(base64Image)、<code>SVGElement</code>。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-tooltip arrow content=&quot;带箭头的提示文字&quot;&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;按钮&lt;/mz-button&gt;
&lt;/mz-tooltip&gt;
</code></pre></template</template
      ></demo-block
    ...
    >
      <a
        ...
        title="动画效果"
        data-level="3"
        data-href="#dong-hua-xiao-guo"
        >¶</a
      >动画效果
    </h3>
    <p>
      另外提供了4类动画效果。您也可以<a
        href="https://atomiks.github.io/tippyjs/v6/animations/#custom-animations"
        target="_blank"
        >自定义动画</a
      >。
    </p>
    <demo-block>
      <template #example
        ><tooltip-demo4 inline-template
          ><div class="tooltip-demo4">
            <div>
            ...
            <div>
              ...
              <mz-tooltip
                ...
                content="shift-away-subtle动画效果"
              >
                <mz-button color="primary">shift-away-subtle</mz-button>
              </mz-tooltip>
              <mz-tooltip
                animation="shift-away-extreme"
                content="shift-away-extreme动画效果"
              >
            ...
            <div>
              ...
              <mz-tooltip
                ...
                content="perspective-subtle动画效果"
              >
                <mz-button color="primary">perspective-subtle</mz-button>
              </mz-tooltip>
              <mz-tooltip
                animation="perspective-extreme"
                content="perspective-extreme动画效果"
              >
      ...
      <template #description
        ><p>
          <code>animation</code>属性控制动画效果，类型<code
            >Boolean / String</code
          >，默认值<code>fade</code>。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;div&gt;
  &lt;mz-tooltip content=&quot;fade 动画效果&quot;&gt;
    &lt;mz-button color=&quot;primary&quot;&gt;fade(默认)&lt;/mz-button&gt;
  &lt;/mz-tooltip&gt;
&lt;/div&gt;
...
&lt;/style&gt;
    ...
    >
    <h3
      id="zhui-sui-shu-biao"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#zhui-sui-shu-biao"
        title="追随鼠标"
        data-level="3"
        data-href="#zhui-sui-shu-biao"
        >¶</a
      >追随鼠标
    </h3>
    <demo-block>
      <template #example
        ><tooltip-demo5 inline-template
          ><div class="tooltip-demo5">
      ...
      <template #description
        ><p>
          <code>follow-cursor</code
          >属性控制鼠标追随情况。默认值<code>false</code>，可选值<code>true</code>:
          启用、<code>false</code>: 禁用、<code>horizontal</code>:
          水平、<code>vertical</code>: 垂直、<code>initial</code>:
          第一次鼠标触及的位置。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-tooltip follow-cursor content=&quot;true&quot;&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;followCursor: true&lt;/mz-button&gt;
&lt;/mz-tooltip&gt;
&lt;mz-tooltip :follow-cursor=&quot;false&quot; content=&quot;false&quot;&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;followCursor: false&lt;/mz-button&gt;
...
&lt;/style&gt;
    ...
    >
    <h3
      id="yu-nei-rong-jiao-hu"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#yu-nei-rong-jiao-hu"
        title="与内容交互"
        data-level="3"
        data-href="#yu-nei-rong-jiao-hu"
        >¶</a
      >与内容交互
    </h3>
    <demo-block>
      <template #example
        ><tooltip-demo6 inline-template
          ><div class="tooltip-demo6">
      ...
      >
      <template #description
        ><p><code>interactive</code>属性控制是否允许你进行内容交互。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-tooltip interactive content=&quot;你可以对提示文字内容进行交互&quot;&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;interactive&lt;/mz-button&gt;
&lt;/mz-tooltip&gt;
</code></pre></template</template
      ></demo-block
    ...
    >
      <a
        class="mz-document-anchor"
        href="#wei-zhi-pian-chi"
        title="位置偏离"
        data-level="3"
        data-href="#wei-zhi-pian-chi"
        >¶</a
      >位置偏离
    </h3>
    <demo-block>
      <template #example
        ><tooltip-demo7 inline-template
          ><div class="tooltip-demo7">
      ...
      <template #description
        ><p>
          <code>offset</code>属性控制位置偏移量，格式是<code
            >[skidding, distance]</code
          >，这两个值的类型都是<code>number</code>，默认值<code>[0, 10]</code>。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-tooltip content=&quot;提示文字&quot;&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;[0, 10]&lt;/mz-button&gt;
&lt;/mz-tooltip&gt;
...
&lt;/style&gt;
      ...
      ></demo-block
    >
    <h3 id="zhu-ti" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#zhu-ti"
        title="主题"
    ...
    <p>
      默认提供了5种主题样式，您也可以<a
        href="https://atomiks.github.io/tippyjs/v6/themes/#creating-a-theme"
        target="_blank"
        >自定义主题样式</a
      >。
    </p>
    <demo-block>
      <template #example
        ><tooltip-demo8 inline-template
          ><div class="tooltip-demo8">
      ...
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-tooltip content=&quot;默认主题&quot;&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;默认主题&lt;/mz-button&gt;
&lt;/mz-tooltip&gt;
...
&lt;/style&gt;
    ...
    >
      <a
        ...
        title="自定义内容"
        data-level="3"
        data-href="#zi-ding-yi-nei-rong"
        >¶</a
      >自定义内容
    </h3>
    <demo-block>
      <template #example
        ><tooltip-demo9 inline-template
          ><div class="tooltip-demo9">
            <mz-tooltip>
      ...
      <template #description></template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-tooltip&gt;
  &lt;mz-button color=&quot;primary&quot;&gt;自定义内容&lt;/mz-button&gt;
  &lt;div slot=&quot;content&quot; style=&quot;width:160px;text-align:center&quot;&gt;
    &lt;h2&gt;Tooltip&lt;/h2&gt;
    &lt;p&gt;欢迎使用tooltip!&lt;/p&gt;
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            / bottom-start / bottom-end / left / left-start / left-end / auto /
            auto-start / auto-end
          </td>
          <td>'top'</td>
        </tr>
        <tr>
          ...
          <td>String</td>
          <td>
            shift-away / shift-away-subtle / shift-away-extreme / shift-toward /
            shift-toward-subtle / shift-toward-extreme / scale / scale-subtle /
            scale-extreme / perspective / perspective-subtle /
            perspective-extreme
          </td>
          <td>'fade'</td>
        </tr>
        ...
        <tr>
          ...
          <td>String</td>
          <td>
            reverse / same / light / light-border / material / translucent
          </td>
          <td>'reverse'</td>
        </tr>
        <tr>
