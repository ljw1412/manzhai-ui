  ...
  <div class="component-checkbox">
    ...
    >
      <a
        ...
        title="Checkbox 多选框"
        data-level="2"
        data-href="#checkbox-duo-xuan-kuang"
        >¶</a
      >Checkbox 多选框
    </h2>
    <p>在数个选项中进行多选。</p>
    ...
    <demo-block>
        ...
        ><checkbox-demo1 inline-template
          ><div class="checkbox-demo1">
            <div>
              ...
              <mz-checkbox v-model="value" trueValue="开" falseValue="关"
                >选择项</mz-checkbox
              >
      ...
      <template #description
        ><p>
          定义<code>v-model</code>绑定变量，单一的<code>checkbox</code>中，默认绑定变量的值会是<code>Boolean</code>，选中为<code>true</code>。如果你定义了<code>trueValue</code>或<code>falseValue</code>时，选中返回<code>trueValue</code>表示的值。
        </p>
      </template>
      <template #highlight
...
&lt;/script&gt;
    ...
    <demo-block>
      ...
      <template #description
        ><p>
          <code>checkbox-group</code>元素能把多个 checkbox
          管理为一组，只需要在<code>Group</code>中使用<code>v-model</code>绑定<code>Array</code>类型的变量即可。
          <code>checkbox</code>的<code>value</code>属性是该 checkbox
          对应的值，<code>label</code>属性是该 checkbox
          对应的标签，也可以通过默认插槽设置。<code>value</code>与数组中的元素值相对应，如果存在指定的值则为选中状态，否则为不选中。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;div&gt;
...
&lt;/script&gt;
    ...
    >
      <a
        ...
        title="不确定状态"
        data-level="3"
        data-href="#bu-que-ding-zhuang-tai"
        >¶</a
      >不确定状态
    </h3>
    <p>
      <code>indeterminate</code> 属性用以表示 checkbox
      的不确定状态，一般用于实现全选的效果
    </p>
    <demo-block>
      <template #example
          ...
          ><div class="checkbox-demo4">
            <div>
              ...
              <mz-checkbox
                ...
                >全选</mz-checkbox
              >
              <mz-checkbox-group v-model="value" @change="onGroupChange">
                <mz-checkbox value="A">选择项A</mz-checkbox>
                <mz-checkbox value="B">选择项B</mz-checkbox>
                <mz-checkbox value="C">选择项C</mz-checkbox>
                <mz-checkbox value="D" disabled>选择项C</mz-checkbox>
        ...
        ><checkbox-demo5 inline-template
          ><div class="checkbox-demo5">
            <div>
              ...
              <mz-checkbox :input-value="true" border disabled
                >选择项3</mz-checkbox
              >
              <mz-checkbox :input-value="false" border disabled
                >选择项4</mz-checkbox
              >
            </div>
          </div></checkbox-demo5
...
&lt;/script&gt;
      ...
      ></demo-block
    >
    <h3 id="checkbox-api" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#checkbox-api"
        title="Checkbox API"
        data-level="3"
        data-href="#checkbox-api"
        >¶</a
      >Checkbox API
    </h3>
