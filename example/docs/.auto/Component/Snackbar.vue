...
<demo-block>
  ...
  <template #description>
    <p><code>icon</code>属性控制前缀图标。你也可以使用<code>prefix</code>插槽，自定义前缀内容。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-snackbar content=&quot;这是一条测试消息。&quot; icon=&quot;flame&quot;/&gt;
...
<demo-block>
  ...
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-snackbar v-model=&quot;isShow&quot;
  content=&quot;这是一条测试消息。&quot;
  :timeout=&quot;0&quot;&gt;
  &lt;template #suffix&gt;
    &lt;mz-button text-color=&quot;#fff&quot;
...
<demo-block>
  ...
  <template #description>
    <p><code>fixed</code>控制是否固定，<code>placement</code>控制消息框在界面的位置。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-snackbar v-model=&quot;isShow&quot;
  fixed
  :content=&quot;`位置：${placement}`&quot;
  :timeout=&quot;0&quot;
...
<demo-block>
  ...
  <template #description>
    <p>方法<code>show</code>里传的config，与组件Snackbar的属性值完全一致。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-button @click=&quot;onClick&quot;&gt;显示&lt;/mz-button&gt;
