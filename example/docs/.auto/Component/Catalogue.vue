  ...
  <div class="component-catalogue">
    ...
    >
      <a
        ...
        href="#catalogue-mu-lu"
        title="Catalogue 目录"
        data-level="2"
        data-href="#catalogue-mu-lu"
        >¶</a
      >Catalogue 目录
    </h2>
    <p>用于列出页面目录。</p>
      ...
      <template #example
        ><catalogue-demo1 inline-template
          ><div class="catalogue-demo1">
            ...
            </mz-catalogue></div></catalogue-demo1
      ></template>
      <template #description
        ><p>
          当 catalogue 组件的<code>manual</code>属性为
          true，默认插槽才可以使用。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-catalogue manual&gt;
  &lt;mz-catalogue-item title=&quot;标题1&quot; :level=&quot;1&quot;&gt;
    &lt;mz-catalogue-item title=&quot;标题1-1&quot; :level=&quot;2&quot;&gt;
      ...
      <template #example
        ><catalogue-demo2 inline-template
          ><div class="catalogue-demo2">
            ...
            </mz-row></div></catalogue-demo2
      ></template>
      <template #description
        ><p>catalogue-item 的<code>target</code>属性指向页面锚点元素的 id。</p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-row&gt;
  &lt;mz-col :span=&quot;16&quot; 
    id=&quot;demo-scroll-container&quot; 
    style=&quot;height: 300px; overflow-y: auto;&quot;&gt;
    &lt;div id=&quot;anchor-1&quot;&gt;位置1&lt;/div&gt;
...
&lt;/mz-row&gt;
    ...
    >
    <h3
      id="gu-ding-ding-wei-mu-lu"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#gu-ding-ding-wei-mu-lu"
        title="固定定位目录"
        data-level="3"
        data-href="#gu-ding-ding-wei-mu-lu"
        >¶</a
      >固定定位目录
    </h3>
    <p>将目录固定在某一个位置。</p>
      ...
      <template #example
        ><catalogue-demo3 inline-template
          ><div class="catalogue-demo3">
            ...
            </div></div></catalogue-demo3
      ></template>
      <template #description
        ><p>
          <code>fixed</code
          >属性控制是否固定。<code>offset</code>控制固定的偏移。
        </p>
      </template>
      <template #highlight
...
&lt;/script&gt;
    ...
    >
    <h3
      id="you-ce-bian-xian-mu-lu"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#you-ce-bian-xian-mu-lu"
        title="有侧边线目录"
        data-level="3"
        data-href="#you-ce-bian-xian-mu-lu"
        >¶</a
      >有侧边线目录
    </h3>
    <p>左侧有节点线条。</p>
      ...
      <template #example
        ><catalogue-demo4 inline-template
          ><div class="catalogue-demo4">
            ...
            </mz-catalogue></div></catalogue-demo4
      ></template>
      <template #description
        ><p>通过<code>sidebar</code>属性控制线条显示与否。</p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-catalogue manual sidebar&gt;
  &lt;mz-catalogue-item title=&quot;标题1&quot; :level=&quot;1&quot;&gt;
    &lt;mz-catalogue-item title=&quot;标题1-1&quot; :level=&quot;2&quot;&gt;
      &lt;mz-catalogue-item title=&quot;标题1-1-1&quot; :level=&quot;3&quot;&gt;&lt;/mz-catalogue-item&gt;
      &lt;mz-catalogue-item title=&quot;标题1-1-2&quot; :level=&quot;3&quot;&gt;&lt;/mz-catalogue-item&gt;
...
&lt;/mz-catalogue&gt;
    ...
    >
    <h3
      id="yu-mao-dian-lian-dong"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#yu-mao-dian-lian-dong"
        title="与锚点联动"
        data-level="3"
        data-href="#yu-mao-dian-lian-dong"
        >¶</a
      >与锚点联动
    </h3>
      ...
      <template #example
        ><catalogue-demo5 inline-template
          ><div class="catalogue-demo5">
            ...
            </mz-row></div></catalogue-demo5
      ></template>
      <template #description
        ><p>
          将 catalogue 设置<code>target</code>(自动匹配的锚点class名称)，与
          anchor
          设置<code>class</code>保持一致。这样可以避免锚点出现互串的情况。anchor
          的<code>title</code>属性值，会作为目录元素的标题。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-row&gt;
...
&lt;/mz-row&gt;
    ...
    >
    <h3
      id="ping-hua-gun-dong"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#ping-hua-gun-dong"
        title="平滑滚动"
        data-level="3"
        data-href="#ping-hua-gun-dong"
        >¶</a
      >平滑滚动
    </h3>
            ...
            <mz-row>
              ...
              <mz-col :span="12">
                <mz-catalogue
                  ...
                  target=".scroll-smooth-anchor"
                ></mz-catalogue>
              </mz-col>
            </mz-row></div></catalogue-demo6
      ></template>
      <template #description
        ><p>
          注意: 该方法使用了<code
            >Element.scrollIntoView({ behavior: 'smooth' })</code
          >，浏览器兼容性<code>firefox 36+ | chrome 61+ | Opera 48+</code>。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-row&gt;
...
&lt;/mz-row&gt;
    ...
    <h3
      id="catalogueitem-api"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#catalogueitem-api"
        title="CatalogueItem API"
        data-level="3"
        data-href="#catalogueitem-api"
        >¶</a
      >CatalogueItem API
    </h3>
