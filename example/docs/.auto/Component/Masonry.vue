  ...
  <div class="component-masonry">
    <div class="update-datetime">文档更新时间：2020-07-20 18:45</div>
      ...
      <demo-block>
        ...
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-masonry :gutter=&quot;5&quot;&gt;
        &lt;mz-masonry-item v-for=&quot;index of 22&quot;
          :key=&quot;index&quot;
          :style=&quot;{
            height: randomNumber(100, 50) + 'px',
      ...
      <demo-block>
        ...
        <template #description>
          <p>masonry的<code>mode</code>属性控制实现方式，默认采用flex布局实现。可选值:<code>flex</code>,<code>column-count</code>。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-masonry :gutter=&quot;5&quot; mode=&quot;column-count&quot;&gt;
        &lt;mz-masonry-item v-for=&quot;index of 22&quot;
          :key=&quot;index&quot;
          :style=&quot;{
            height: randomNumber(100, 50) + 'px',
