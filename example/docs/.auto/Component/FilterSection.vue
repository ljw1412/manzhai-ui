...
<demo-block>
  ...
  <template #description>
    <p><code>label-position</code>用来控制选择项的标签的位置，可选值为<code>top</code>、<code>left</code>、<code>right</code>。属性值<code>label-width</code>控制标签的宽度。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;div style=&quot;margin-bottom:10px&quot;&gt;
  &lt;span&gt;标签位置：&lt;/span&gt;
  &lt;mz-radio-group v-model=&quot;position&quot; name=&quot;position&quot;&gt;
    &lt;mz-radio-button value=&quot;top&quot; border&gt;top&lt;/mz-radio-button&gt;
    &lt;mz-radio-button value=&quot;left&quot; border&gt;left&lt;/mz-radio-button&gt;
...
<demo-block>
  <template #example>
    ...
    </filter-section-demo8>
  </template>
  <template #description>
    <p><code>size</code>属性控制显示大小。</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-filter-section v-for=&quot;size of sizes&quot; :key=&quot;size&quot;
  v-model=&quot;value&quot; label=&quot;产地：&quot; :size=&quot;size&quot;
  label-position=&quot;right&quot; label-width=&quot;100px&quot;&gt;
  &lt;mz-filter-section-item v-for=&quot;country of countries&quot;
    :key=&quot;country.value&quot;
