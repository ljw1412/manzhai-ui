<template>
  <div class="component-filter-section">
    ...
    <h2
      id="filtersection-shai-xuan-xiang"
      class="mz-heading mz-document-heading"
      data-level="2"
    >
      <a
        class="mz-document-anchor"
        href="#filtersection-shai-xuan-xiang"
        title="FilterSection 筛选项"
        data-level="2"
        data-href="#filtersection-shai-xuan-xiang"
        >¶</a
      >FilterSection 筛选项
    </h2>
    <p>用于筛选条件的选择。</p>
    ...
    <demo-block>
      ...
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;div class=&quot;demo-font-size-14&quot;&gt;当前值：{{ value }}&lt;/div&gt;
&lt;mz-filter-section v-model=&quot;value&quot; label=&quot;产地：&quot;&gt;
...
&lt;/script&gt;
    ...
    >
    <h3
      id="xian-tiao-xiao-guo"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#xian-tiao-xiao-guo"
        title="线条效果"
        data-level="3"
        data-href="#xian-tiao-xiao-guo"
        >¶</a
      >线条效果
    </h3>
    <demo-block>
          ...
          ><div class="filter-section-demo2">
            ...
            <mz-filter-section v-model="value" label="漫画类型" outlined>
              ...
              <mz-filter-section-item
                ...
                label="禁用"
              ></mz-filter-section-item>
            </mz-filter-section></div></filter-section-demo2
      ></template>
      <template #description
...
&lt;/script&gt;
    ...
    >
    <h3
      id="bei-jing-xiao-guo"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#bei-jing-xiao-guo"
        title="背景效果"
        data-level="3"
        data-href="#bei-jing-xiao-guo"
        >¶</a
      >背景效果
    </h3>
    <demo-block>
...
&lt;/script&gt;
    ...
    <demo-block>
      <template #example
        ><filter-section-demo4 inline-template
          ><div class="filter-section-demo4">
            ...
            <mz-filter-section
              ...
              label-width="100px"
            >
              <mz-filter-section-item v-for="i of 12" :key="i" :value="i"
                >{{ i }}月</mz-filter-section-item
              >
            </mz-filter-section>
          </div></filter-section-demo4
        ></template
      >
      <template #description
        ><p>
          <code>label-position</code
          >用来控制选择项的标签的位置，可选值为<code>top</code>、<code>left</code>、<code>right</code>。属性值<code>label-width</code>控制标签的宽度。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;div style=&quot;margin-bottom:10px&quot;&gt;
  &lt;span&gt;标签位置：&lt;/span&gt;
  &lt;mz-radio-group v-model=&quot;position&quot; name=&quot;position&quot;&gt;
    &lt;mz-radio-button value=&quot;top&quot; border&gt;top&lt;/mz-radio-button&gt;
    &lt;mz-radio-button value=&quot;left&quot; border&gt;left&lt;/mz-radio-button&gt;
...
&lt;/style&gt;
    ...
    >
      <a
        class="mz-document-anchor"
        href="#duo-xuan-mo-shi"
        title="多选模式"
        data-level="3"
        data-href="#duo-xuan-mo-shi"
        >¶</a
      >多选模式
    </h3>
    <p>可以选择多个选择项。</p>
        ...
        ><filter-section-demo5 inline-template
          ><div class="filter-section-demo5">
            ...
            <mz-filter-section v-model="value" label="类型1：" multiple>
              <mz-filter-section-item v-for="i of 10" :key="i" :value="i"
                >选项{{ i }}</mz-filter-section-item
              >
            </mz-filter-section>
          </div></filter-section-demo5
        ></template
      >
      <template #description
...
&lt;/script&gt;
    ...
    >
    <h3
      id="shai-xuan-xiang-zu"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#shai-xuan-xiang-zu"
        title="筛选项组"
        data-level="3"
        data-href="#shai-xuan-xiang-zu"
        >¶</a
      >筛选项组
    </h3>
        ...
        ><filter-section-demo6 inline-template
          ><div class="filter-section-demo6">
            ...
            <mz-filter-section-group v-model="groupValue">
              <mz-filter-section name="type1" label="类型1(name=type1)：">
                <mz-filter-section-item v-for="i of 10" :key="i" :value="i"
                  >选项{{ i }}</mz-filter-section-item
                >
              </mz-filter-section>
              <mz-filter-section
                label="类型2(name=type2)："
                name="type2"
                multiple
              >
                <mz-filter-section-item v-for="i of 10" :key="i" :value="i"
          ...
          </div></filter-section-demo6
        ></template
      >
      <template #description
        ><p>
          filterSection的<code>name</code>属性是该选项组的中筛选项的唯一标识。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;div class=&quot;demo-font-size-14&quot;&gt;当前值：{{groupValue}}&lt;/div&gt;
&lt;mz-filter-section-group v-model=&quot;groupValue&quot;&gt;
...
&lt;/script&gt;
    ...
    >
    <h3
      id="zi-ding-yi-xuan-zhong-xiao-guo"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#zi-ding-yi-xuan-zhong-xiao-guo"
        title="自定义选中效果"
        data-level="3"
        data-href="#zi-ding-yi-xuan-zhong-xiao-guo"
        >¶</a
      >自定义选中效果
    </h3>
    <demo-block>
          ...
          ><div class="filter-section-demo7">
            ...
            <mz-filter-section v-model="value" label="类型1：" custom>
              ...
              >
                <div
                  slot-scope="{ checked }"
                  :class="{ 'is-item-checked': checked }"
                >
                  选项{{ i }}
                </div>
              </mz-filter-section-item>
            </mz-filter-section>
          </div></filter-section-demo7
        ></template
      >
      <template #description
        ><p>
          filterSectionItem
          的<code>custom</code>属性如果是true，可以关闭默认的选中效果。通过<code>slot-scope</code>可以获得当前选择项的选中状态情况。
        </p>
      </template>
      <template #highlight
        >><pre
...
&lt;/style&gt;
    ...
    >
      <a
        class="mz-document-anchor"
        href="#bu-tong-da-xiao"
        title="不同大小"
        data-level="3"
        data-href="#bu-tong-da-xiao"
        >¶</a
      >不同大小
    </h3>
    <demo-block>
      <template #example
        ><filter-section-demo8 inline-template
          ><div class="filter-section-demo8">
            <mz-filter-section
              v-for="size of sizes"
              :key="size"
              v-model="value"
            ...
            >
              <mz-filter-section-item
                ...
                :key="country.value"
                :value="country.value"
                >{{ country.label }}</mz-filter-section-item
              >
            </mz-filter-section>
          </div></filter-section-demo8
        ></template
      >
      <template #description
        ><p><code>size</code>属性控制显示大小。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-filter-section v-for=&quot;size of sizes&quot; :key=&quot;size&quot;
...
&lt;/script&gt;
    ...
    >
    <h3
      id="filtersection-api"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#filtersection-api"
        title="FilterSection API"
        data-level="3"
        data-href="#filtersection-api"
        >¶</a
      >FilterSection API
    </h3>
    ...
    <h3
      id="filtersectionitem-api"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#filtersectionitem-api"
        title="FilterSectionItem API"
        data-level="3"
        data-href="#filtersectionitem-api"
        >¶</a
    ...
    <h4 id="shi-jian-2" class="mz-heading mz-document-heading" data-level="4">
      <a
        class="mz-document-anchor"
        href="#shi-jian-2"
        title="事件"
        data-level="4"
        data-href="#shi-jian-2"
        >¶</a
      >事件
    </h4>
    <table>
    ...
    <h4
      id="zuo-yong-yu-cha-cao"
      class="mz-heading mz-document-heading"
      data-level="4"
    >
      <a
        class="mz-document-anchor"
        href="#zuo-yong-yu-cha-cao"
        title="作用域插槽"
        data-level="4"
        data-href="#zuo-yong-yu-cha-cao"
        >¶</a
      >作用域插槽
    </h4>
    <table>
    ...
    <h3
      id="filtersectiongroup-api"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#filtersectiongroup-api"
        title="FilterSectionGroup API"
        data-level="3"
        data-href="#filtersectiongroup-api"
        >¶</a
    ...
    <h4 id="shi-jian-3" class="mz-heading mz-document-heading" data-level="4">
      <a
        class="mz-document-anchor"
        href="#shi-jian-3"
        title="事件"
        data-level="4"
        data-href="#shi-jian-3"
        >¶</a
      >事件
    </h4>
    <table>
