<template>
  <div class="component-card">
    ...
    >
      <a
        class="mz-document-anchor"
        href="#qia-pian-hai-ba"
        title="卡片海拔"
        data-level="3"
        data-href="#qia-pian-hai-ba"
        >¶</a
      >卡片海拔
    </h3>
          ...
          ><div class="card-demo1">
            <div>
              ...
              <mz-button
                ...
                >+</mz-button
              >
              <mz-card width="80%" height="200px" :elevation="elevation">
...
&lt;/script&gt;
    ...
    >
    <h3
      id="xian-tiao-qia-pian"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#xian-tiao-qia-pian"
        title="线条卡片"
        data-level="3"
        data-href="#xian-tiao-qia-pian"
        >¶</a
      >线条卡片
    </h3>
    <p>有线条围绕的扁平卡片</p>
    <demo-block>
      <template #example
        ><card-demo2 inline-template
          ><div class="card-demo2">
            <mz-card outlined width="80%" height="200px">
              <span>边框卡片</span>
            </mz-card>
          </div></card-demo2
        ></template
      ...
      <template #description
        ><p>
          注意:
          当使用<code>outlined</code>属性展示线条卡片时，会自动将<code>elevation</code>降到0。
        </p>
      </template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-card outlined
  width=&quot;80%&quot;
  height=&quot;200px&quot;&gt;
  &lt;span&gt;边框卡片&lt;/span&gt;
&lt;/mz-card&gt;
