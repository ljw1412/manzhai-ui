  ...
  <div class="component-loading">
        ...
        ><loading-demo1 inline-template
          ><div class="loading-demo1">
            <mz-loading
              ...
              :mode="i"
              :key="i"
            ></mz-loading></div></loading-demo1
      ></template>
      <template #description></template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-loading v-for=&quot;i of 7&quot; :mode=&quot;i&quot; :key=&quot;i&quot;&gt;&lt;/mz-loading&gt;
</code></pre></template</template
      ></demo-block
    >
    <h3
      id="zuo-wei-kuai-de-jia-zai"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#zuo-wei-kuai-de-jia-zai"
        title="作为块的加载"
        data-level="3"
        data-href="#zuo-wei-kuai-de-jia-zai"
        >¶</a
      >作为块的加载
    </h3>
    <p>有内容嵌套再内部。</p>
    <demo-block>
      ...
      <template #description
        ><p><code>loading</code>属性控制当前是否为加载状态。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-switch v-model=&quot;loading&quot;&gt;&lt;/mz-switch&gt;
&lt;mz-loading :loading=&quot;loading&quot;&gt;
  &lt;div class=&quot;height-200&quot;&gt;我是内容&lt;/div&gt;
&lt;/mz-loading&gt;
...
&lt;/script&gt;
    ...
    >
    <h3
      id="zi-ding-yi-wen-an"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#zi-ding-yi-wen-an"
        title="自定义文案"
        data-level="3"
        data-href="#zi-ding-yi-wen-an"
        >¶</a
      >自定义文案
    </h3>
    <p>自定义加载时的文案。</p>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>加载图标的类型下的多种效果</td>
          <td>Number</td>
          <td><code>four-color</code>:<code>1-7</code></td>
          <td>1</td>
        </tr>
        <tr>
          <td>loading</td>
