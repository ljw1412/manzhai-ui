<template>
  <div class="component-anchor">
    ...
    <demo-block>
      <template #example
        ><anchor-demo1 inline-template
          ><div class="anchor-demo1">
            <div>
      ...
      <template #description
        ><p><code>level</code>属性来控制标题大小，默认为<code>3</code>。</p>
      </template>
      <template #highlight
...
&lt;/div&gt;
    ...
    >
    <h3
      id="yin-bi-shi-mao-dian"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#yin-bi-shi-mao-dian"
        title="隐蔽式锚点"
        data-level="3"
        data-href="#yin-bi-shi-mao-dian"
        >¶</a
      >隐蔽式锚点
    </h3>
    <p>不可见的锚点。</p>
    <demo-block>
      <template #example
        ><anchor-demo2 inline-template
          ><div class="anchor-demo2">
            <mz-anchor
              href="#anchor-invisible"
              title="不可见锚点-1"
              invisible
            ></mz-anchor></div></anchor-demo2
      ></template>
      <template #description
        ><p><code>invisible</code>属性来控制锚点的可见性。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-anchor href=&quot;#anchor-invisible&quot; title=&quot;不可见锚点-1&quot; invisible&gt;&lt;/mz-anchor&gt;
</code></pre></template</template
      ></demo-block
    >
    <h3
      id="yu-mu-lu-lian-dong"
      class="mz-heading mz-document-heading"
      data-level="3"
    >
      <a
        class="mz-document-anchor"
        href="#yu-mu-lu-lian-dong"
        title="与目录联动"
        data-level="3"
        data-href="#yu-mu-lu-lian-dong"
        >¶</a
      >与目录联动
    </h3>
    <p>
      配合 <a href="component-catalogue">目录(Catalogue)组件</a> 使用效果更好。
    </p>
    <demo-block>
      <template #example
        ><anchor-demo3 inline-template
          ><div class="anchor-demo3">
            <mz-row>
              <mz-col
                :span="12"
            ...
            </mz-row></div></anchor-demo3
      ></template>
      <template #description
        ><p>
          将 catalogue 设置 <code>target</code>(自动匹配的锚点class名称)，与
          anchor 设置
          <code>class</code>保持一致。这样可以避免锚点出现互串的情况。anchor
