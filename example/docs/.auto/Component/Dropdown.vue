<template>
  <div class="component-dropdown">
    <div class="update-datetime">文档更新时间：2020-07-20 18:45</div>
      ...
      <demo-block>
        <template #example>
          <dropdown-demo1 inline-template>
            <div class="dropdown-demo1">
              <mz-dropdown>
        ...
        <template #description>
            </template><template #highlight><pre v-pre><code class="html">&lt;mz-dropdown&gt;
        &lt;span class=&quot;username&quot;&gt;用户&lt;/span&gt;
        &lt;mz-list slot=&quot;content&quot; style=&quot;width:120px;&quot; size=&quot;small&quot; clickable&gt;
          &lt;mz-list-item title=&quot;个人中心&quot;&gt;&lt;/mz-list-item&gt;
          &lt;mz-list-item title=&quot;消息&quot;&gt;&lt;/mz-list-item&gt;
...
<script>
export default { name: 'ComponentDropdown', components: { DropdownDemo1: {} } }
</script>
