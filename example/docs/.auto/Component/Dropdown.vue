<template>
  <div class="component-dropdown">
    ...
    <h2
      id="dropdown-xia-la-kuang"
      class="mz-heading mz-document-heading"
      data-level="2"
    >
      <a
        class="mz-document-anchor"
        href="#dropdown-xia-la-kuang"
        title="Dropdown 下拉框"
        data-level="2"
        data-href="#dropdown-xia-la-kuang"
        >¶</a
      >Dropdown 下拉框
    </h2>
    <p>点击元素，弹出下拉框。</p>
      ...
      <template #example
        ><dropdown-demo1 inline-template
          ><div class="dropdown-demo1">
            ...
            </mz-dropdown></div></dropdown-demo1
      ></template>
      <template #description></template>
      <template #highlight
        >><pre v-pre><code class="html">&lt;mz-dropdown&gt;
  &lt;span class=&quot;username&quot;&gt;用户&lt;/span&gt;
...
&lt;/style&gt;
    ...
    <p>
      <strong
        >此组件插槽与事件与组件<a href="component-tooltip#cha-cao">Tooltip</a
        >一致</strong
      >
    </p>
  </div>
