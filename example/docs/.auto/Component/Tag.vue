    ...
    <div class="update-datetime">文档更新时间：2020-07-20 18:45</div>
      ...
      <demo-block>
        ...
        <template #description>
          <p><code>color</code>控制标签背景颜色,<code>text-color</code>控制标签文本颜色。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-tag&gt;标签&lt;/mz-tag&gt;
      &lt;mz-tag color=&quot;#3f51b5&quot; text-color=&quot;#ffffff&quot;&gt;标签&lt;/mz-tag&gt;
      &lt;mz-tag color=&quot;#ffc107&quot; text-color=&quot;green&quot;&gt;标签&lt;/mz-tag&gt;
      ...
      <demo-block>
        ...
        <template #description>
          <p><code>size</code>可以控制尺寸，可选值<code>small</code>、<code>medium</code>、<code>large</code>。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-tag size=&quot;small&quot;&gt;标签&lt;/mz-tag&gt;
      &lt;mz-tag size=&quot;medium&quot;&gt;标签&lt;/mz-tag&gt;
      &lt;mz-tag&gt;标签&lt;/mz-tag&gt;
      &lt;mz-tag size=&quot;large&quot;&gt;标签&lt;/mz-tag&gt;
      </code></pre></template></demo-block><h3 id="xing-tai" class="mz-heading mz-document-heading" data-level="3"><a class="mz-document-anchor" href="#xing-tai" title="形态" data-level="3" data-href="#xing-tai">¶</a>形态</h3>
      <p>多种样式形态的标签。</p>
      <demo-block>
        <template #example>
          <tag-demo3 inline-template>
            <div class="tag-demo3">
        ...
        <template #description>
          <p><code>outlined</code>、<code>round</code>、<code>text</code>分别表示以边框模式，圆角模式，文字模式显示。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-tag outlined&gt;标签&lt;/mz-tag&gt;
      &lt;mz-tag round color=&quot;#3f51b5&quot; text-color=&quot;#ffffff&quot;&gt;标签&lt;/mz-tag&gt;
      &lt;mz-tag round=&quot;left&quot; color=&quot;#3f51b5&quot; text-color=&quot;#ffffff&quot;&gt;标签&lt;/mz-tag&gt;
      &lt;mz-tag round=&quot;right&quot; color=&quot;#3f51b5&quot; text-color=&quot;#ffffff&quot;&gt;标签&lt;/mz-tag&gt;
      &lt;mz-tag text color=&quot;#3f51b5&quot; text-color=&quot;#ffffff&quot;&gt;标签&lt;/mz-tag&gt;
      ...
      <demo-block>
        ...
        <template #description>
          <p><code>closable</code>属性控制标签能否被删除，点击删除图标返回<code>v-on:close</code>事件。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-tag v-for=&quot;(item, index) of list&quot; 
        :key=&quot;index&quot;
        closable
        @close=&quot;handleColse(item)&quot;&gt;
        {{item.label}}
      ...
      &lt;/script&gt;
      </code></pre></template></demo-block><h3 id="qian-hou-zhi-nei-rong" class="mz-heading mz-document-heading" data-level="3"><a class="mz-document-anchor" href="#qian-hou-zhi-nei-rong" title="前后置内容" data-level="3" data-href="#qian-hou-zhi-nei-rong">¶</a>前后置内容</h3>
      <p>在标签内容前后插入其它内容。</p>
      <demo-block>
        <template #example>
          <tag-demo5 inline-template>
            <div class="tag-demo5">
              <mz-tag>
        ...
        <template #description>
          <p><code>prefix</code>、<code>suffix</code>使用前后置插槽在标签名称前后插入内容。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-tag&gt;
        &lt;mz-icon slot=&quot;prefix&quot; name=&quot;bookmark&quot;&gt;&lt;/mz-icon&gt;
        标签
      &lt;/mz-tag&gt;
      &lt;mz-tag&gt;
...
export default {
  ...
  components: {
    ...
    TagDemo4: {
      data() {
        return {
          list: [{ label: '标签1' }, { label: '标签2' }, { label: '标签3' }]
        }
      },
