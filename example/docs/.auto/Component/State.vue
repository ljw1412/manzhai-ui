<template>
  <div class="component-state">
    ...
    <h2
      id="state-zhuang-tai-bian-hua"
      class="mz-heading mz-document-heading"
      data-level="2"
    >
      <a
        class="mz-document-anchor"
        href="#state-zhuang-tai-bian-hua"
        title="State 状态变化"
        data-level="2"
        data-href="#state-zhuang-tai-bian-hua"
        >¶</a
      >State 状态变化
    </h2>
    <p>根据状态显示不同内容</p>
    ...
    <demo-block>
      <template #example
        ><state-demo1 inline-template
          ><div class="state-demo1">
            <mz-button
              outlined
              :disabled="loading"
              color="danger"
      ...
      <template #description
        ><p>
          <code>value</code
          >表示当前状态，它的可选值与你所使用的插槽名称对应。(以下面的Demo为例，此时可选值为<code>loading</code>、<code>empty</code>、<code>success</code>)
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-button outlined :disabled=&quot;loading&quot; color=&quot;danger&quot;
...
&lt;/style&gt;
    ...
    <demo-block>
      <template #example
        ><state-demo2 inline-template
          ><div class="state-demo2">
            <mz-filter-section
              label="状态："
              multiple
      ...
      >
      <template #description
        ><p><code>value</code>以<code>,</code>分隔表示多状态。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-filter-section label=&quot;状态：&quot;
  multiple
  label-position=&quot;right&quot;
  v-model=&quot;state&quot;&gt;
