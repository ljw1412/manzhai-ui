...
<demo-block>
  ...
  <template #description>
    <p><code>value</code>表示当前状态，它的可选值与你所使用的插槽名称对应。(以下面的Demo为例，此时可选值为<code>loading</code>、<code>empty</code>、<code>success</code>)</p>
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-button outlined :disabled=&quot;loading&quot; color=&quot;danger&quot;
  @click=&quot;loadData(true)&quot;&gt;加载空数据&lt;/mz-button&gt;
&lt;mz-button outlined :disabled=&quot;loading&quot; color=&quot;success&quot;
  @click=&quot;loadData(false)&quot;&gt;加载有数据&lt;/mz-button&gt;
&lt;mz-state :value=&quot;state&quot;&gt;
...
<demo-block>
  ...
  </template><template #highlight><pre v-pre><code class="html">&lt;mz-filter-section label=&quot;状态：&quot;
  multiple
  label-position=&quot;right&quot;
  v-model=&quot;state&quot;&gt;
  &lt;mz-filter-section-item v-for=&quot;item of stateList&quot;
