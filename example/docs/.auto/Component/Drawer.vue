<template>
  <div class="component-drawer">
    ...
    <demo-block>
      <template #example
        ><drawer-demo1 inline-template
          ><div class="drawer-demo1">
            <mz-filter-section
              v-model="placement"
              label="抽屉弹出位置："
            ...
            <mz-drawer
              ...
              title="抽屉！！！"
              :placement="placement"
            ></mz-drawer></div></drawer-demo1
      ></template>
      <template #description
        ><p>
          <code>placement</code
          >可以控制抽屉弹出的位置。可选值<code>top</code>、<code>bottom</code>、<code>left</code>、<code>right</code>。默认值<code>right</code>。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-filter-section v-model=&quot;placement&quot;
...
&lt;/script&gt;
    ...
    >
      <a
        class="mz-document-anchor"
        href="#bu-tong-cha-cao"
        title="不同插槽"
        data-level="3"
        data-href="#bu-tong-cha-cao"
        >¶</a
      >不同插槽
    </h3>
    ...
    <demo-block>
      <template #example
        ><drawer-demo2 inline-template
          ><div class="drawer-demo2">
            ...
            <mz-drawer v-model="visible" :placement="placement">
              ...
              <mz-button-group v-if="isDisplay('footer')" slot="footer" block>
                ...
                <mz-button color="success" @click="visible = false"
                  >关闭</mz-button
                >
              </mz-button-group>
            </mz-drawer>
      ...
      <template #description
        ><p>
          布局插槽主要有三个，分别为<code>title</code>、<code>默认</code>、<code>footer</code>。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;span class=&quot;demo-font-size-14&quot;&gt;显示的插槽：&lt;/span&gt;
...
&lt;/script&gt;
    ...
    >
      <a
        class="mz-document-anchor"
        href="#dai-fen-ge-xian"
        title="带分割线"
        data-level="3"
        data-href="#dai-fen-ge-xian"
        >¶</a
      >带分割线
    </h3>
    <demo-block>
      <template #example
        ><drawer-demo3 inline-template
          ><div class="drawer-demo3">
            <mz-button color="success" @click="visible = true"
              >显示抽屉</mz-button
            >

            <mz-drawer v-model="visible" divider :placement="placement">
      ...
      >
      <template #description
        ><p><code>divider</code>可以控制抽屉是否带有分割线。</p>
      </template>
      <template #highlight
...
&lt;/script&gt;
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>height</td>
          <td>高度，仅placement为'top','bottom'时有效。</td>
          <td>String</td>
          <td></td>
          <td>'512px'</td>
        </tr>
