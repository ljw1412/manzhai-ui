<template>
  <div class="component-elevation">
    <div class="update-datetime">文档更新时间：2020-03-18 14:39</div>
...
</div></elevation-demo1></template>
        <template #description><p><code>v-elevation</code>属性传入范围为 0-24 之间的整数。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;div v-elevation=&quot;elevation&quot;
  style=&quot;width:100%;height:200px;&quot;&gt;
  &lt;mz-button-group&gt;
    &lt;mz-button outlined
      color=&quot;primary&quot;
