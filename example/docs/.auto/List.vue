...
</div></list-demo2></template>
        <template #description><p><code>divider</code>可以控制列表是否带有分割线。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-card width=&quot;300px&quot; class=&quot;m-auto&quot;&gt;
  &lt;mz-list divider&gt;
    &lt;mz-list-item title=&quot;所有人&quot; text=&quot;来个火箭&quot;&gt;
...
</div></list-demo3></template>
        <template #description><p><code>clickable</code>控制能否点击的效果。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-card width=&quot;300px&quot; class=&quot;m-auto&quot;&gt;
  &lt;mz-list clickable&gt;
    &lt;mz-list-item title=&quot;所有人&quot; text=&quot;来个火箭&quot;&gt;
...
</div></list-demo4></template>
        <template #description><p><code>gutter</code>可以控制列表元素间的间距。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-list width=&quot;300px&quot; class=&quot;m-auto&quot; gutter=&quot;10px&quot;&gt;
  &lt;mz-list-item v-for=&quot;i of 4&quot; :key=&quot;i&quot;&gt;
    &lt;mz-card height=&quot;50px&quot;&gt;&lt;span&gt;我是卡片{{i}}&lt;/span&gt;&lt;/mz-card&gt;
  &lt;/mz-list-item&gt;
&lt;/mz-list&gt;
...
</div></list-demo5></template>
        <template #description><p>List的<code>disabled</code>属性可以控制整个列表的禁用状态。也可以单独控制ListItem。</p>
</template>
...
</div></list-demo6></template>
        <template #description><p>当<code>list</code>有<code>value/v-model</code>属性时，进入选择模式，且<code>list-item</code>的<code>value</code>属性不能为<code>undefined</code>，使用<code>list-item</code>的<code>item</code>属性传入任意相关数据。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-list v-model=&quot;value&quot; 
  width=&quot;300px&quot; class=&quot;m-auto&quot;
  @change=&quot;change&quot; @item-click=&quot;itemClick&quot;&gt;
  &lt;mz-list-item v-for=&quot;item of list&quot;
    :item=&quot;item&quot;
...
export default {
  name: 'ComponentList',
  components: { ListDemo1: {}, ListDemo2: {}, ListDemo3: {}, ListDemo4: {}, ListDemo5: {}, ListDemo6: {
  data() {
    return {
      value: '',
      currentItem:{},
