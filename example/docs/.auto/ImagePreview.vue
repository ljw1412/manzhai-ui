<template>
  <div class="component-image-preview">
    <div class="update-datetime">文档更新时间：2020-03-05 15:26</div>
...
<tr>
<td>visible</td>
<td>是否显示，可以使用<code>.sync</code>修饰</td>
<td>Boolean</td>
<td></td>
<td></td>
</tr>
