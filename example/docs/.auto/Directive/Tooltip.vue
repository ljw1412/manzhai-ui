<template>
  <div class="directive-tooltip">
    ...
    <p>
      简单的提示文字处理，如果要进行自定义请使用组件<a href="component-tooltip"
        >Tooltip</a
      >
    </p>
    <h3
    ...
    <demo-block>
      ...
      <template #description
        ><p><code>v-tooltip</code>直接传入字符串。如果内容为假值则不显示。</p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-button v-tooltip=&quot;'文字'&quot;&gt;按钮&lt;/mz-button&gt;
    ...
    >
      <a
        class="mz-document-anchor"
        href="#jin-jie-yong-fa"
        title="进阶用法"
        data-level="3"
        data-href="#jin-jie-yong-fa"
        >¶</a
      >进阶用法
    </h3>
    <p>
      您也可以向<code>v-tooltip</code>传入一个对象，对象的<a
    ...
    <demo-block>
      ...
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-row flex class=&quot;align-items-center&quot;&gt;
  &lt;mz-col style=&quot;width: 80px; text-align: center;&quot;&gt;
...
&lt;/style&gt;
      ...
      ></demo-block
    >
    <h3 id="xiu-shi-fu" class="mz-heading mz-document-heading" data-level="3">
      <a
        class="mz-document-anchor"
        href="#xiu-shi-fu"
        title="修饰符"
        data-level="3"
        data-href="#xiu-shi-fu"
        >¶</a
      >修饰符
    </h3>
    <p>
      <strong>主题:</strong> <code>light</code>, <code>light-border</code>,
      <code>material</code>, <code>translucent</code>
    </p>
    <p><strong>箭头:</strong> <code>arrow</code></p>
    <p>
      <strong>触发:</strong> <code>hover</code>, <code>focus</code>,
      <code>click</code>
    </p>
    <p>
      <strong>位置:</strong> <code>top</code>, <code>top-start</code>,
      <code>top-end</code>, <code>right</code>, <code>right-start</code>,
      <code>right-end</code>, <code>bottom</code>, <code>bottom-start</code>,
    ...
    <demo-block>
        ...
        ><tooltip-demo3 inline-template
          ><div class="tooltip-demo3">
            <div class="modifiers">
              ...
              <mz-tag v-tooltip.light-border="'light-border'"
                >light-border</mz-tag
              >
            ...
            <div class="modifiers">
              ...
              <mz-tag v-tooltip.arrow.light-border="'light-border'"
                >light-border</mz-tag
              >
              <mz-tag v-tooltip.arrow.material="'material'">material</mz-tag>
              <mz-tag v-tooltip.arrow.translucent="'translucent'"
                >translucent</mz-tag
              >
            </div>
            <div class="modifiers">
      ...
      <template #highlight
        >><pre v-pre><code class="html">&lt;div class=&quot;modifiers&quot;&gt;
  &lt;mz-tag v-tooltip=&quot;'文字'&quot;&gt;默认&lt;/mz-tag&gt;
  &lt;mz-tag v-tooltip.light=&quot;'light'&quot;&gt;light&lt;/mz-tag&gt;
