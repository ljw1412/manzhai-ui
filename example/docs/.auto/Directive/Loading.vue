<template>
  <div class="directive-loading">
    ...
    <p>
      <strong
        >如果出现样式问题，请使用<a href="component-loading">MzLoading组件</a
        >。</strong
      >
    </p>
    <h3
    ...
    <demo-block>
      ...
      <template #description
        ><p>
          <code>v-loading</code
          >指令控制加载的状态控制，类型<code>Boolean</code>。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;mz-button color=&quot;primary&quot; @click=&quot;load&quot;&gt;加载&lt;/mz-button&gt;
...
&lt;/script&gt;
    ...
    >
      <a
        class="mz-document-anchor"
        href="#can-shu-pei-zhi"
        title="参数配置"
        data-level="3"
        data-href="#can-shu-pei-zhi"
        >¶</a
      >参数配置
    </h3>
    <demo-block>
      ...
      <template #description
        ><p>
          以下是所有可以配置的属性，它们的可选值与MzLoading对应属性值一致。唯一区别这些属性值都是<code>String</code>类型。
        </p>
      </template>
      <template #highlight
        >><pre
          v-pre
        ><code class="html">&lt;span class=&quot;demo-font-size-14&quot;&gt;加载开关：&lt;/span&gt;
&lt;mz-switch v-model=&quot;loading&quot;&gt;&lt;/mz-switch&gt;
