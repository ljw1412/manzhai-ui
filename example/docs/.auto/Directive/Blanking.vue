  ...
  <div class="directive-blanking">
    <div class="update-datetime">文档更新时间：2020-07-20 18:45</div>
      ...
      <demo-block>
        ...
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-snackbar v-model=&quot;show&quot;
        v-blanking=&quot;blanking-demo-1&quot;
        content=&quot;这是一条测试消息。&quot;
        :timeout=&quot;0&quot;&gt;
        &lt;template #suffix&gt;
      ...
      <demo-block>
        ...
        <template #description>
          <p>使用<code>v-blanking</code>指令，传入一个对象，<code>key</code>作为唯一索引,<code>display</code>代表当前显示状态。一旦<code>display</code>变为<code>false</code>,则自动切换为已读状态。</p>
        </template><template #highlight><pre v-pre><code class="html">&lt;mz-snackbar v-model=&quot;show&quot;
        v-blanking=&quot;{
          key: 'blanking-demo-2',
          display: show
