...
</div></tabs-demo1></template>
        <template #description><p>tabs的<code>value</code>/<code>v-model</code>表示当前显示的标签值，即与tab的<code>value</code>属性对应。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-tabs v-model=&quot;value&quot;&gt;
  &lt;mz-tab v-for=&quot;index of 5&quot;
    :key=&quot;index&quot;
    :label=&quot;'Tab'+index&quot;
    :value=&quot;index&quot;&gt;标签页{{index}}&lt;/mz-tab&gt;
...
</div></tabs-demo2></template>
        <template #description><p>tabs的<code>grow</code>属性可以控制标签是否平铺。</p>
</template>
