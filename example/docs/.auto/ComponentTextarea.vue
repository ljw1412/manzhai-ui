<template>
  <div class="component-textarea">
    <div class="update-datetime">文档更新时间：2020-07-03 11:54</div>
...
<demo-block>
        <template #example><textarea-demo1 inline-template><div class="textarea-demo1">
  <mz-textarea v-model="value" placeholder="请输入"></mz-textarea>
</div></textarea-demo1></template>
        <template #description></template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-textarea v-model=&quot;value&quot; placeholder=&quot;请输入&quot;&gt;&lt;/mz-textarea&gt;
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="bu-tong-yang-shi" class="mz-heading mz-document-heading" data-level="3"><a class="mz-document-anchor" href="#bu-tong-yang-shi" title="不同样式" data-level="3" data-href="#bu-tong-yang-shi">¶</a>不同样式</h3>
<demo-block>
        <template #example><textarea-demo2 inline-template><div class="textarea-demo2">
...
</div></textarea-demo2></template>
        <template #description><p><code>flat</code>属性控制是否使用扁平效果。<code>shadow</code>属性控制是否使用阴影显示。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;p class=&quot;demo-font-size-14&quot;&gt;shadow&lt;/p&gt;
&lt;mz-textarea v-model=&quot;value&quot; shadow placeholder=&quot;请输入&quot;&gt;&lt;/mz-textarea&gt;
&lt;p class=&quot;demo-font-size-14&quot;&gt;flat&lt;/p&gt;
&lt;mz-textarea v-model=&quot;value2&quot; flat placeholder=&quot;请输入&quot;&gt;&lt;/mz-textarea&gt;
...
<demo-block>
        <template #example><textarea-demo3 inline-template><div class="textarea-demo3">
  <mz-textarea v-model="value" placeholder="请输入" disabled></mz-textarea>
</div></textarea-demo3></template>
        <template #description><p><code>disabled</code>属性控制是否禁用。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-textarea v-model=&quot;value&quot; placeholder=&quot;请输入&quot; disabled&gt;&lt;/mz-textarea&gt;
...
<script>
export default {
  name: 'ComponentComponentTextarea',
  components: { TextareaDemo1: {
  data (){
    return {
      value: ''
    }
