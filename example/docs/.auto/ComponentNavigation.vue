<template>
  <div class="component-navigation">
    <div class="update-datetime">文档更新时间：2020-06-22 15:04</div>
...
<demo-block>
        <template #example><navigation-demo1 inline-template><div class="navigation-demo1">
  <mz-navigation :data="data"
    style="width:300px"></mz-navigation>
</div></navigation-demo1></template>
        <template #description></template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-navigation :data=&quot;data&quot;
  style=&quot;width:300px&quot;&gt;&lt;/mz-navigation&gt;
...
<h4 id="navigationitem" class="mz-heading mz-document-heading" data-level="4"><a class="mz-document-anchor" href="#navigationitem" title="NavigationItem" data-level="4" data-href="#navigationitem">¶</a>NavigationItem</h4>
<table>
<thead>
<tr>
<th>属性</th>
...
<tr>
<td>group</td>
<td>组名称，当有此属性，对象里只能接children</td>
<td>String</td>
</tr>
<tr>
<td>icon</td>
...
<script>
export default {
  name: 'ComponentComponentNavigation',
