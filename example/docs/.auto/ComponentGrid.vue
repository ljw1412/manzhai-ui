...
</div></grid-demo1></template>
        <template #description><p>通过设置 col 的 <code>span</code>属性我们可以进行列的不同组合搭配。</p>
</template>
...
</div></grid-demo2></template>
        <template #description><p>通过 row 的<code>gutter</code>属性来指定每一栏之间的间隔，默认间隔为 0。</p>
</template>
...
</div></grid-demo4></template>
        <template #description><p>通过设置col的<code>offset</code>属性可以使当前列偏移指定列数。</p>
</template>
        <template #highlight><pre v-pre><code class="html">&lt;mz-row :gutter=&quot;16&quot;&gt;
  &lt;mz-col :span=&quot;6&quot;&gt;&lt;div class=&quot;grid-col bg-base&quot;&gt;&lt;/div&gt;&lt;/mz-col&gt;
  &lt;mz-col :span=&quot;6&quot; :offset=&quot;6&quot;&gt;&lt;div class=&quot;grid-col bg-base&quot;&gt;&lt;/div&gt;&lt;/mz-col&gt;
...
</div></grid-demo5></template>
        <template #description><p>通过设置 row 的<code>flex</code>属性，来启用 flex 布局。启动之后，可以通过<code>justify</code>属性指定 'start', 'center', 'end', 'space-between', 'space-around', 'space-evenly'中的值来定义列元素的水平布局。通过<code>align</code>属性指定'top', 'middle', 'bottom'中的值来定义列的垂直布局。</p>
</template>
