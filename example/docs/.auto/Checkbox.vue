...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="jin-yong-zhuang-tai" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#jin-yong-zhuang-tai">¶</a>禁用状态</h3>
<p>多选框不可用状态。</p>
<demo-block>
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="duo-xuan-kuang-zu" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#duo-xuan-kuang-zu">¶</a>多选框组</h3>
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="bu-que-ding-zhuang-tai" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#bu-que-ding-zhuang-tai">¶</a>不确定状态</h3>
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="checkbox-api" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#checkbox-api">¶</a>Checkbox API</h3>
...
<h3 id="checkboxgroup-api" class="mz-header mz-document-header" data-level="3"><a class="mz-document-anchor" href="#checkboxgroup-api">¶</a>CheckboxGroup API</h3>
...
<h4 id="shi-jian-2" class="mz-header mz-document-header" data-level="4"><a class="mz-document-anchor" href="#shi-jian-2">¶</a>事件</h4>
<table>
<thead>
<tr>
<th>名称</th>
